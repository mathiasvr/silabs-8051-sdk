...
// --------------------
//
// Example software to demonstrate the C8051F36x SMBus interface in
...
//    USB cable to P4.
// 3) Connect SPI bus to another C8051Fxxx SMBus multimaster.
...
//
//      'F36x Multimaster                     Other C8051Fxxx Multimaster
//         LED (blinks) <------------------------------ Switch
//         SW -----------------------------------------> LED (blinks)
//
//
...
SI_SBIT(SW,  SFR_P3, 0);                 // Switch on P1.0
...
//
// P3.0   digital   open-drain    SW (switch)
