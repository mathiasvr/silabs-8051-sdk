...
// --------------------
//
// This example demonstrates how the C8051F36x SMBus interface can communicate
...
//    USB cable to P4.
// 3) Connect SPI bus to a 24LC02B serial
...
void main (void)
{
   int8_t in_buff[8] = {0};                // Incoming data buffer
   int8_t out_buff[8] = "ABCDEFG";         // Outgoing data buffer
...
SI_INTERRUPT(SMBUS0_ISR, SMBUS0_IRQn)
{
   ...
   static int8_t i;                      // Used by the ISR to count the
