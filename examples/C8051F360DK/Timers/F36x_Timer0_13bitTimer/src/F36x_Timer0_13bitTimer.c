...
// --------------------
//
// This program presents an example of use of the Timer0 of the C8051F36x's
// in 13-bit counter/timer mode. It uses the 'F360DK as HW platform and blinks
