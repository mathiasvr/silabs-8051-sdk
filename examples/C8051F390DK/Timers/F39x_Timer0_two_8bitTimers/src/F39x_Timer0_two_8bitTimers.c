...
SI_SBIT(LED, SFR_P1, 1);                 // LED==1 means ON, toggled by TL0
SI_SBIT(SIGNAL, SFR_P1, 7);              // SIGNAL is toggled by TH0
...
//
// P1.1   digital   push-pull   LED (toggled by TL0)
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x82;                     // Set LED and SIGNAL to push-pull
}
