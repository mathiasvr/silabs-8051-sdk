...
// Program Description:
//
// This program presents an example of use of the Timer2 of the C8051F390's in
// two 8-bit reload counter/timer mode. It uses the 'F390 UDP MCU board.
//
...
SI_SBIT(LED, SFR_P1, 1);                 // LED==1 means ON, toggled by TMR2L
SI_SBIT(SIGNAL, SFR_P1, 7);              // SIGNAL is toggled by TMR2H
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x82;                     // Set LED and SIGNAL to
...
// Using the internal osc. at 49MHz/16 with a timer prescaler of 1:12
