...
// Program Description:
//
// Example software to demonstrate the 'F39x/7x SMBus interface in Slave mode
...
// 2) Download code to a 'F39x/7x device that is connected to a SMBus master.
