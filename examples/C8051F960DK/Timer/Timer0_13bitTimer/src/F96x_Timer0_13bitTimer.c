...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051F96x's
// in 13-bit counter/timer mode. It uses the UDP F960 MCU MUX LCD board or 
// the UDP F960 MCU EMIF board as HW platform and blinks LED1. To do so it uses
// an interrupt driven by the Timer0 which toggles the LED every 100msec.
//
// Pinout:
//
//    P0.0(LCD) / P3.0(EMIF) -> LED
//
...
// (SYSCLK, in this case the internal clock @20Hz/8 or about 2.5MHz) with a
// 1:48 prescaler.
