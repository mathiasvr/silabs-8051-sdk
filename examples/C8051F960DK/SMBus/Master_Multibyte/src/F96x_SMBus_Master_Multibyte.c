...
// 2) Connect the device to another device running SMBus Slave code.
...
//            toggling the LED3 on and off each time a value is sent and
//            received.
...
SI_SBIT(SDA, SFR_P0, 0);                 // SMBus on P0.1
SI_SBIT(SCL, SFR_P0, 1);                 // and P0.2
