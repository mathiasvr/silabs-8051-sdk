...
// module to count pulses in single counter mode with a Form C type
// reed-switch.
//
...
//
//   Form C reed switch. When a magnetic field is applied, a connection is made
//   to GND. Otherwise, a connection is made to Vbat.
//   
//  Vbat
//   |____   
//   ___  \____x
...
//    Alternatively, a pulse source can be connected directly to P1.0.
