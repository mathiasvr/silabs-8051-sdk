...
//-----------------------------------------------------------------------------
const SI_SEGMENT_VARIABLE(FontMapNumeric[NUM_NUMERIC], uint32_t, SI_SEG_CODE) =
{
   CHAR_0,
   CHAR_1,
   CHAR_2,
...
const SI_SEGMENT_VARIABLE(FontMapAlpha[NUM_ALPHA], uint32_t, SI_SEG_CODE) =
{
   CHAR_A,
   CHAR_B,
   CHAR_C,
...
void lcdSetBitMap(uint32_t bitmap, uint8_t index);
//-----------------------------------------------------------------------------
// lcdPutChar()
//
