...
//=============================================================================
void IncrementCounter (SI_VARIABLE_SEGMENT_POINTER(counter, uint8_t, SI_SEG_XDATA));
//=============================================================================
// API Functions
//=============================================================================
//-----------------------------------------------------------------------------
...
CTR_ENCRYPT_DECRYPT_STATUS
   ...
   SI_VARIABLE_SEGMENT_POINTER(counter, uint8_t, SI_SEG_XDATA),
   SI_VARIABLE_SEGMENT_POINTER(encryptionKey, uint8_t, SI_SEG_XDATA),
   uint16_t blocks)
{
   // Unions used for compiler independent endianness.
   SI_UU16_t length;                        // Length in bytes for all blocks.
   SI_UU16_t addr;                          // Union used to access pointer bytes.
