...
//-----------------------------------------------------------------------------
typedef uint8_t CTR_ENCRYPT_DECRYPT_OPERATION;
typedef uint8_t CTR_ENCRYPT_DECRYPT_STATUS;
//=============================================================================
// Function Prototypes (API)
//=============================================================================
CTR_ENCRYPT_DECRYPT_STATUS CTR_EncryptDecrypt (uint8_t operation,
