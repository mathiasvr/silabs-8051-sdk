...
//
//-----------------------------------------------------------------------------
const SI_SEGMENT_VARIABLE(ManchesterUnencodedData[NUM_MANCHESTER_UNENCODED_BYTES],
                        uint8_t, SI_SEG_CODE) =
{
   0x01,
   0x12,
...
//
//-----------------------------------------------------------------------------
const SI_SEGMENT_VARIABLE(ManchesterEncodedData[NUM_MANCHESTER_ENCODED_BYTES],
                        uint8_t, SI_SEG_CODE) =
{
...
//
//-----------------------------------------------------------------------------
const SI_SEGMENT_VARIABLE(ThreeOutOfSixUnencodedData[NUM_THREEOUTOFSIX_UNENCODED_BYTES],
                        uint8_t, SI_SEG_CODE) =
{
   0x01, 0x23,
   0x12, 0x34,
...
//-----------------------------------------------------------------------------
const SI_SEGMENT_VARIABLE(ThreeOutOfSixEncodedData[NUM_THREEOUTOFSIX_ENCODED_BYTES],
                        uint8_t, SI_SEG_CODE) =
{
