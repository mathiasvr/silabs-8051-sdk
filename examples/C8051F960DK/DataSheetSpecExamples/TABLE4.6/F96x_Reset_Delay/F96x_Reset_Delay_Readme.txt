...
P0.0   (LED1 - Non-POR Delay Monitor)
P0.1   (LED2 - POR Delay Status Monitor)
...
Specs Demonstrated:
--------------------------------------------------------------------------------
Table 4.6 VBAT Ramp Time for Power-On Reset (POR)
   - Delay from VDD On to RST Logic High:
      + Min: --
	  + Typ: --
	  + Max: 3 ms
      
Table 4.6 Reset Time Delay (RST) - Non-POR Delay
...
How to Use:
--------------------------------------------------------------------------------
Refer to F96x_Reset_Delay.asm for detailed directions on using this example.
