...
//
// This example demonstrates the offset, offset error, temperature measurement,
// and supply current of the built-in temperature sensor, as specified on table
// 4.13 of the datasheet.
//
//
// Refer to F96x_Temperature_Sensor_Readme.txt for more information 
// regarding this code example's functionality. 
//
//
// How to Measure (Table 4.13):
// ----------------------------------------------------
// 1) Place VBAT SEL switch (SW5) in the VREG position.
...
#define AMBIENT_TC      27              // Ambient temperature
//-----------------------------------------------------------------------------
// Global Variables
//-----------------------------------------------------------------------------
...
void main (void)
{
    ...
    // Print opening text
    printf("F96x_Temperature_Sensor.c \n");
    printf("---------------------------------------------- \n");      
    ...
    while (1)
    {
        ...
        while( !inputLatch )
        {
            ...
            printf("---------------------------------------------- \n");
            printf("To adjust offset , Press 1. \n");
