...
P0.0 (LED1 toggle for Flash Write/Erase and Pin Used for Measurement)
P0.1 (Flash Write Initialization Switch)
P0.2 (Flash Erase Initialization Switch)
...
How to Use:
--------------------------------------------------------------------------------
Refer to F96x_Flash_Access.c for detailed directions on using this example.
