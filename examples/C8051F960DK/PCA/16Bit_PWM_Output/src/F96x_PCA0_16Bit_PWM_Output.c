...
// 7) Measure the PWM waveform on P0.0.
// 8) Verify that the duty cycle of the waveform varies smoothly between
...
void OSCILLATOR_Init (void)
{
   ...
   CLKSEL = 0x00;                      // Select precision internal osc.                                     // divided by 1 as the system clock
}
