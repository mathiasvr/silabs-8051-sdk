...
// How To Test:
//
// 1) Download code to a 'F540 device which has an oscilloscope monitoring P0.0
// 2) Make sure the jumper is disconnected on J13.
...
#define CEX0_FREQUENCY 54000L          // Frequency to output on CEX0 (Hz)
