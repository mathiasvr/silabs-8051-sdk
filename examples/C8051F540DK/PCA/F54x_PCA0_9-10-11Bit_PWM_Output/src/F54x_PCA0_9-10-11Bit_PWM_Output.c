//-----------------------------------------------------------------------------
// F540_PCA0_9-10-11Bit_PWM_Output.c
//-----------------------------------------------------------------------------
...
// 2) Remove shorting block on J13
// 3) Download code to a F54x device which has an oscilloscope monitoring P0.0
//    If running on a 'F540 target board, remove the shorting block from the 
//    J13 header (Side A) or J19 header (Side B).
// 4) Run the program - the waveform should be visible on the oscilloscope.
// 5) Verify that the duty cycle of the waveform varies smoothly between
