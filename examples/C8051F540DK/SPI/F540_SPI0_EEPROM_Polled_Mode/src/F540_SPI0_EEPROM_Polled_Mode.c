...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F540 MCU
...
// connections of the 'F540 MCU are shown here:
//
...
//
// Method1:
// 1) Download the code to a 'F540 device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F540 device that is connected as above
...
#define  T_NSS_DISABLE_MIN 540         // Min NSS disable time (ns)
