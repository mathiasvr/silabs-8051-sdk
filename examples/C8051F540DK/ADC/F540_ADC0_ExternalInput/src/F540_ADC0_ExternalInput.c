...
//
// The analog multiplexer selects P1.2 as the ADC0 input.  The C8051F54x
// ADC supports single-ended inputs and so the voltage on P1.2 is compared to
// GND.
//
// P1.2 on the C8051F540-TB is connected to a potentiometer.  When the
...
// How To Test:
// ------------
// 1) Download code to a 'F540 device on a C8051F540-TB development board
...
// 4) Ensure that a shorting block is put on J17 (potentiometer) and J13 (VREF)
