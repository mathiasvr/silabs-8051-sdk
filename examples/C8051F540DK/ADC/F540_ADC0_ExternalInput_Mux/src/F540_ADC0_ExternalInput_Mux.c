...
// VREF and AGND and connect potentiometer to a pin of P2.x as shown below:
//
// ---------
//          |
//         o| AGND ----|
...
// How To Test:
//
// 1) Download code to a 'F540 device that is connected to a UART transceiver
// 2) Verify the TX and RX jumpers are populated on J14.
