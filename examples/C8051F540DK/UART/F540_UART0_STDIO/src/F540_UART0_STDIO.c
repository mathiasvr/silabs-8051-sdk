...
// Program Description:
//
// This program demonstrates how to configure the C8051F540 to use routines
...
// How To Test:
//
// 1) Ensure that jumpers are placed on J14 of the C8051F540 target board
...
// 5) Download and execute code to an 'F540 target board.
// 6) Press any key in the terminal, then the character and the HEX value of the
//    charaFollow will be echoed back.
//
