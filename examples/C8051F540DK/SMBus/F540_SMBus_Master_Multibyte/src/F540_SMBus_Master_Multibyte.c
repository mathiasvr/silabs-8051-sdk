...
// Program Description:
//
// Example software to demonstrate the C8051F540 SMBus interface in
// Master mode.
...
// 2) Download code to a 'F540 device that is connected to a SMBus slave.
// 3) Run the code:
//         a) The test will indicate proper communication with the Multibyte
//            slave by toggling the LED on and off each time a value is sent
//            and received.
