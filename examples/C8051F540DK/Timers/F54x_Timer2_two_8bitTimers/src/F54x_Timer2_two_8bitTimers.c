...
// Program Description:
//
// This program presents an example of use of the Timer2 of the C8051F540's in
...
// 3) Verify the LED pins of J19 are populated on the 'F540 TB.
// 4) Connect an oscilloscope up to SIGNAL (P1.5) to verify the correct rate.
// 5) Run the code.
// 6) Verify that the LED is blinking and SIGNAL is toggling.
//
//
// Target:         C8051F540 (Side A of C8051F540TB)
