...
void OSCILLATOR_Init (void)
{
   ...
   OSCICN = 0x08;                      // Select external oscillator as system
                                       // clock source and disable the internal
                                       // oscillator.
}
...
void PORT_Init (void)
{
   ...
   P0MDIN &= ~0x0C;                    // P0.2, P0.3 are analog 
  	XBR0   |=  0x0C;                    // P0.2, P0.3 skipped in the Crossbar
