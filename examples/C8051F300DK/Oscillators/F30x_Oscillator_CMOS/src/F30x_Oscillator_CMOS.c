...
//    - J3: P0.2_LED
// 3) Connect the CMOS input clock to XTAL2 / P0.3
// 4) Connect the USB Debug Adapter to J4.
// 5) Connect the 9V power adapter to P1.
...
//         Oscillator
//      - the 'F30x will also output the SYSCLK to a port pin (P0.0) for
//         observation
//
//
// Target:         C8051F300
...
void PORT_Init (void)
{
   ...
   XBR0 = 0x0C;                        // Skip the LED and XTAL2 pins
