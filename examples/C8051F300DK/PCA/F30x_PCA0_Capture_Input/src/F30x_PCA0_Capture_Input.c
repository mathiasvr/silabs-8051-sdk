...
// How To Test:
//
// 1) Connect the USB Debug Adapter to J4.
// 2) Connect the 9V power adapter to P1.
// 3) Connect P0.0 to P0.1.
// 3) Compile and download code to a 'F300 device on a C8051F300-TB development
...
// 5) Halt the program inside the PCA ISR (line 296).
...
// 1) Connect the USB Debug Adapter to J4.
// 2) Connect the 9V power adapter to P1.
// 3) Run a separate signal generator into the P0.0 pin.
// 4) Compile and download code to a 'F300 device on a C8051F300-TB development
//    board selecting Run -> Debug from the menus, clicking the Debug button in
//    the quick menu, or pressing F11.
// 5) Run the code by selecting Run -> Resume from the menus, clicking the
//    Resume button in the quick menu, or pressing F8.
// 6) Halt the program inside the PCA ISR (line 296).
...
void PORT_Init (void)
{
   XBR0    = 0x00;                     // Don't skip any pins with crossbar
   XBR1    = 0x40;                     // Route CEX0 to P0.0,
