...
//      - the 'F30x SMBus master should detect any conflict using SMB0CN_ARBLOST
//      - the 'F30x SMBus master should give up the bus, if necessary, and
//        switch to slave receiver mode
//      - the 'F30x SMBus master should transmit after the other master is done
// - Pinout:
//    P0.0 -> SDA (SMBus)
//    P0.1 -> SCL (SMBus)
//    P0.2 -> LED
...
// 3) Connect the device to another 'Fxxx SMBus Multi-master.
...
//
//      'F30x Multimaster                     Other C8051Fxxx Multimaster
//         LED (blinks) <------------------------------ Switch
//              SW --------------------------------> LED (blinks)
//
...
SI_SBIT(SW, SFR_P0, 3);                   // Switch on P0.3
...
// P0.3   digital   open-drain    SW (switch)
//
// all other port pins unused
//
