...
Main:
            ...
            setb  TMR2CN_TR2                     ; START Timer2
            setb  ADC0CN_ADEN                   ; enable ADC

            setb  IE_EA                      ; enable global interrupts
...
ADC0_ISR:
            ...
            clr   ADC0CN_ADINT                  ; clear ADC0 interrupt flag
...
;
Timer2_Init:
            mov   TMR2CN, #00h            ; STOP Timer2, clear TMR2CN_TF2H and TMR2CN_TF2L;
            ...
            mov   TMR2L, #0ffh
            clr   IE_ET2                     ; disable Timer2 interrupts
