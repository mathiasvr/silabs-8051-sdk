...
// two 8-bit counter/timer mode. It uses the 'F300DK as HW platform.
//
...
// reaching the value defined by LED_TOGGLE_RATE toggles the LED (P0.2)
...
SI_SBIT(SIGNAL, SFR_P0, 7);               // SIGNAL to be used also by Timer0
...
//
// P0.2   digital   push-pull     LED (toggled by TL0)
//
