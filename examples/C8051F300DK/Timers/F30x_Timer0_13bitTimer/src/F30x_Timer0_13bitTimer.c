...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051F30x's
// in 13-bit counter/timer mode. It uses the 'F300DK as HW platform and blinks
...
SI_SBIT(LED1, SFR_P0, 2);                  // LED='1' means ON
