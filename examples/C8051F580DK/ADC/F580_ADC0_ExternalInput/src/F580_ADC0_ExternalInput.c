...
//
// The analog multiplexer selects P1.2 as the ADC0 input.  The C8051F580
// ADC supports single-ended inputs and so the voltage on P1.2 is compared to
// GND.
//
// P1.2 on the C8051F580-TB is connected to a potentiometer.  When the
...
// UART0.  A UART0 initialization routine is therefore necessary.
//
...
// How To Test:
// ------------
// 1) Download code to a 'F580 device on a C8051F580-TB development board
...
// Command Line:   None
//
// Release 1.3 / 10 JUL 2015 (SG)
//    - Revised for Simplicity Studio
//
// Release 1.2 / 11 MAR 2010 (GP)
//    -Tested with Raisonance
//
// Release 1.1 / 16 DEC 2008 (GP)
//    - Updated Reference Initialization to 2.25 V
//
...
void main (void)
{
   SFRPAGE = ACTIVE1_PAGE;             // Set for PCA0MD
