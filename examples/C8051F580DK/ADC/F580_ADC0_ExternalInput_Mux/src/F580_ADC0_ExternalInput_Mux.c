...
// How To Test:
//
// 1) Download code to a 'F580 device that is connected to a UART transceiver
...
void main (void)
{
   ...
   SFRPAGE = ACTIVE1_PAGE;             // Set for PCA0MD and for printf()
   ...
   // SFRPAGE is already set to ACTIVE1_PAGE for printf()
...
// Using the internal osc. at 24 MHz with a prescaler of 1:8 and reloading the
