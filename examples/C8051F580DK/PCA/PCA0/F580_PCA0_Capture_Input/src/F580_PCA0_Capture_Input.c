...
// memory.
//
// In this example, PCA0 Module 0 is used to capture rising edges of an
...
void PORT_Init (void)
{
   ...
   P0MDOUT = 0x03;                     // Set CEX0 (P0.0) to push-pull
                                       // Set TEST_OUT (P0.1) to push-pull
...
// Parameters   : None
//
// This is the ISR for PCA0.  It handles the case when a capture occurs on
