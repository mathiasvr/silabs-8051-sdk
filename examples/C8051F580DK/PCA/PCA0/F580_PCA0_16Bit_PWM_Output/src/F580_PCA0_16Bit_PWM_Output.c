...
//
// In this example, PCA0 Module 0 is used to generate the waveform, and the
...
// Parameters   : None
//
// This is the ISR for PCA0.  It handles the case when a match occurs on
...
SI_INTERRUPT(PCA0_ISR, PCA0_IRQn)
{
   ...
   else                                // Other modules caused interrupt
   {
      PCA0CN &= ~0xBE;                 // Clear flag
   }
}
