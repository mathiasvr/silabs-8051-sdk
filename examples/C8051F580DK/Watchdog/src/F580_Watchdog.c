...
// and enabled in the software as needed. When enabled the PCA0 Module 5 acts
// as the WDT. This program resets the MCU when P1.4 switch is pressed. Also
// upon reset the LED blinks approximately five times faster when compared to
...
//
// How to Test:
// 1) Compile and download code to a 'F580 device.
...
void main (void)
{
   SFRPAGE = ACTIVE1_PAGE;             // Set SFR Page for PCA0MD and RSTSRC
...
void TIMER2_Init (uint16_t counts)
{
   ...
   TMR2CN = 0x00;                      // Stop Timer2; Clear TCON_TF2;
