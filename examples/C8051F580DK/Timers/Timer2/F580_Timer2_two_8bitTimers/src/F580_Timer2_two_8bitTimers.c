...
// Program Description:
//
// This program presents an example of use of the Timer2 of the C8051F580's in
...
// How To Test:
//
// 1) Open the F580_Timer2_two_8bitTimers.c file in the Silicon Labs IDE.
// 2) If necessary change the number of interrupts to toggle an output:
//    LED_TOGGLE_RATE
//    SIGNAL_TOGGLE_RATE
// 3) Compile and download the code.
// 4) Verify the LED pins of J19 are populated on the 'F580 TB.
...
#define TIMER2_RELOAD  (uint16_t)(0xFF - (SYSCLK/TIMER_PRESCALER/1000))



SI_SBIT(LED, P1, 3);                     // LED==0 means ON
SI_SBIT(SIGNAL, P1, 5);                  // SIGNAL to be used also by Timer2
...
void OSCILLATOR_Init (void)
{
   ...
   OSCICN = 0x84;                      // Internal Oscillator / 8
