...
// How To Test:
//
// 1) Ensure that a quartz crystal (Y1), 10Meg resistor (R2), and 33pF loading
//    capacitors (C6 and C7) are installed on the C8051F580-TB.
...
//
#define CRYSTAL_FREQUENCY    4000000   //  Crystal Frequency in Hz
