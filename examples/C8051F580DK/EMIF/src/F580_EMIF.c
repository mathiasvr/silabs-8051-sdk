...
// How To Test:
//
// 1) Connect the C8051F580-TB to an AB1 expansion board.  The AB1 expansion
//    board includes a 128K SRAM.
// 2) On the C8051F580-TB, remove the jumper on the J20 header to
//    disconnect the potentiometer from the port pin used for RAM CS
// 3) Download code to the side 'A' MCU on a C8051F580-TB
...
SI_SBIT(RAM_BANK, SFR_P1, 5);            // Bank select bit is P1^5
SI_SBIT(RAM_CS, SFR_P1, 2);              // Chip select bit is P1^2
...
void main (void)
{
   ...
   SFRPAGE = ACTIVE1_PAGE;             // Set page for PCA and UART0
...
// P1.5   digital   push-pull    RAM_BANK
// P1.6   digital   push-pull    /RD
// P1.7   digital   push-pull    /WR
//
// P2     digital   push-pull    Address pins A8-15
// P3     digital   push-pull    Address pins A0-7
// P4     digital   push-pull    Data pins D0-D7
//
//-----------------------------------------------------------------------------
