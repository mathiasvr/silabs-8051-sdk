...
// How To Test:
//
// 1) Build and Download F580_SMBus_Master.c to Side A of a 'F580-TB
// 2) Build and Download F580_SMBus_Slave.c to Side B of a 'F580-TB
...
//            received.
//         b) Another method to verify the proper functionality is:
//            - Place the cursor at the line which reads "Run to here".
//            - Click the menu Run > Toggle Breakpoint.
//            - Click Resume in the toolbar.
//            - Click the Variables view. Verify that the variable
//              "SMB_DATA_IN" is equal to "SMB_DATA_OUT" and that
//              "NUM_ERRORS" is zero.
//
...
// TEST CODE-------------------------------------------------------------------
   ...
   while (1)
   {
      ...
      T0_Wait_ms (50);                 // Wait 50 ms until the next cycle
                                       // so that LED is slow enough to see
