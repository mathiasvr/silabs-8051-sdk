...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8BB1 STK (SMBus GPIO Expander) + EFR32 STK (Command
// Interpreter/SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device EFM8BB1 STK to EFR32 STK running the corresponding
//    I2C CLI code.
