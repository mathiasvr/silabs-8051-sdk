...
#define COLOR_GREEN     Colors[0]
#define COLOR_YELLOW    Colors[1]
#define COLOR_ORANGE    Colors[2]
...
void UpdateThreatLevel()
{
    ...
    threatLevel = ((uint16_t)Enemy_y * 100) / (BOTTOM_LINE_LIMIT - TOP_LINE_LIMIT - TOTAL_ENEMY_HEIGHT);
