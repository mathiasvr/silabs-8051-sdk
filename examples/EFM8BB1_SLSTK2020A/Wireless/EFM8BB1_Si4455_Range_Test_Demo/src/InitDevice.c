...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 ...
	 //     conversion signal.)
	 */
	ADC0CF = (0x03 << ADC0CF_ADSC__SHIFT) | ADC0CF_AD8BE__8_BIT
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	 ...
	 */
	EIP1 = EIP1_PADC0__HIGH | EIP1_PWADC0__HIGH | EIP1_PCP0__LOW
			| EIP1_PCP1__LOW | EIP1_PMAT__LOW | EIP1_PPCA0__LOW
			| EIP1_PSMB0__LOW | EIP1_PT3__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
