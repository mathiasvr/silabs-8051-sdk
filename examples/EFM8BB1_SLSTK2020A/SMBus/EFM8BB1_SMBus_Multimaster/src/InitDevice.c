...
extern void enter_BusFreeMode_from_RESET(void) {
	...
	PORTS_0_enter_BusFreeMode_from_RESET();
	PORTS_1_enter_BusFreeMode_from_RESET();
...
extern void PORTS_0_enter_BusFreeMode_from_RESET(void) {
	// $[P0 - Port 0 Pin Latch]
	/*
	 // B0 (Port 0 Bit 0 Latch) = HIGH (P0.0 is high. Set P0.0 to drive or
	 //     float high.)
...
extern void PORTS_1_enter_BusFreeMode_from_RESET(void) {
	// $[P1 - Port 1 Pin Latch]
	/*
...
extern void PORTS_1_enter_DefaultMode_from_BusFreeMode(void) {
	...
	P1SKIP = P1SKIP_B0__SKIPPED | P1SKIP_B1__SKIPPED | P1SKIP_B2__NOT_SKIPPED
			| P1SKIP_B3__NOT_SKIPPED | P1SKIP_B4__SKIPPED
