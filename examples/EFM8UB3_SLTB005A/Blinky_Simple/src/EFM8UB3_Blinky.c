...
// Program Description:
//
// This program flashes the green LED on the EFM8UB3 MCU board about
...
//
// Release 1.3
//    - Go to bootloader mode with BTN0 switch is pressed (BG)
//    - 13 MAR 2018
//
// Release 1.2
...
// Global CONSTANTS
//-----------------------------------------------------------------------------
#define SYSCLK       48000000/4/8      // SYSCLK frequency in Hz
SI_SBIT(LED, SFR_P1, 4);               // P1.4 LED
SI_SBIT(BTN0, SFR_P0, 2);              // BTN0 switch ('SW1' on BRD5002A)
...
//
// P1.4 - LED (push-pull output)
//
void Port_Init (void)
{
   P1MDOUT |= 0x10;                    // Enable LED as a push-pull output
