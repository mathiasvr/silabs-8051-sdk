...
// Program Description:
//
// This program tests all the functions available in EFM8UB3_FlashPrimitives.c
// and EFM8UB3_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8UB3 devices with less than 8 kB of memory will need to
...
#include "EFM8UB3_FlashPrimitives.h"
#include "EFM8UB3_FlashUtils.h"
