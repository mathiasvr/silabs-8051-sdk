...
//
// The analog multiplexer selects P0.2 (ADC0.2) as the positive ADC0 input.
...
//
// A push button is connected to P0.2. It is active-low. So it will read
// high without being pressed, and will go to 0v when pressed.
//
...
// 6) Press the push button. The terminal program will print the voltage for
...
void main (void)
{
   ...
   SCON1_TI = 1;                       // This STDIO library requires TI to
