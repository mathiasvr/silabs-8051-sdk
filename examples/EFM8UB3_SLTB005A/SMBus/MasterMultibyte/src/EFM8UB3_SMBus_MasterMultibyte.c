//-----------------------------------------------------------------------------
// EFM8UB3_SMBus_MasterMultibyte.c
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8UB3 STK (SMBus Master) + EFM8UB3 STK (SMBus Slave)
//-----------------------------------------------------------------------------
// 1) Connect the device first EFM8UB3 STK to second EFM8UB3 STK running the
//    corresponding SMBus_Slave code.
// 2) Place the SW104 switch in "AEM" mode.
// 3) Connect the EFM8UB3 STK board to a PC using a mini USB cable.
// 4) Compile and download code to the first EFM8UB3 STK board.
...
#include "EFM8UB3_SMBus_MasterMultibyte.h"
