//-----------------------------------------------------------------------------
// F560DC_ADC0_TemperatureSensor.c
//-----------------------------------------------------------------------------
...
// Program Description:
//
// This program measures the temperature sensor on an 'F560 device and outputs
...
// How To Test:
//
// 1) Connect the ToolStick560DC to a ToolStick Base Adapter.
...
temp_sense_out Get_Temperature_Voltage (void)
{
   ...
   // V(temp) = (Accumulator / 2^16) * VREF (2.20V)
   // Offset  = TEMP_SENSOR_OFFSET (856 mV)
   // Slope   = TEMP_SENSOR_GAIN   (3.330 mV / deg C)
