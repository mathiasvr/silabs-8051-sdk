...
// crossbar is configured to send the CEX0 pin out on P0.6.
//
//
// How To Test:
// ------------
...
//      or pressing F8.
// 5) Observe the triangle wave on P0.6 LED. Or connect P0.6 to an oscilloscope
//    and verify that the duty cycle of the waveform varies smoothly between
...
void PCA0_Init (void)
{
   ...
   // Module 0 = 16-bit PWM mode and enable Module 0 Match and Interrupt Flags
