...
//
// This program configures a C8051F35x as a SPI Slave. The 'F35x MCU
...
void PORT_Init (void)
{
   P0MDOUT = 0x42;                     // Make MISO push-pull
...
void SPI0_Init()
{
   // Enable the SPI as a slave, CKPHA = '0', CKPOL = '0'
   SPI0CFG = SPI0CFG_MSTEN__MASTER_DISABLED |
             SPI0CFG_CKPHA__DATA_CENTERED_FIRST |
             SPI0CFG_CKPOL__IDLE_LOW;

   // 4-wire Slave mode, SPI enabled
   SPI0CN = SPI0CN_NSSMD__4_WIRE_SLAVE |
