...
static SI_SEGMENT_VARIABLE(STRING0_DESC[STRING0_LEN], const uint8_t, SI_SEG_CODE) =
{
...
static SI_SEGMENT_VARIABLE(STRING1_DESC[STRING1_LEN], const uint8_t, SI_SEG_CODE) =
{
   STRING1_LEN, 0x03,
   'S', 0,
   'i', 0,
...
static SI_SEGMENT_VARIABLE(STRING2_DESC[STRING2_LEN], const uint8_t, SI_SEG_CODE) =
{
   STRING2_LEN, 0x03,
   'C', 0,
   '8', 0,
