...
P1.0   (LED1 - Non-POR Delay Monitor)
P1.1   (LED2 - POR Delay Status Monitor)
...
Specs Demonstrated:
--------------------------------------------------------------------------------
Table 1.3 Reset Delay (RST) - Power-On Reset (POR)
   - Delay from VDD On to RST Logic High:
      + Min: 3 ms
	  + Typ: --
	  + Max: TBD
Table 1.3 Reset Delay (RST) - Non-POR Delay
   - Delay from VDD Threshold (1.95 V) to Code Execution:
      + Min: --
	  + Typ: 30 us
	  + Max: --
...
How to Use:
--------------------------------------------------------------------------------
Refer to F85x_Reset_Delay.asm for detailed directions on using this example.
