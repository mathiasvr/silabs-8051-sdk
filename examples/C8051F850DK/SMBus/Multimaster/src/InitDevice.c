...
extern void SMBUS_0_enter_DefaultMode_from_BusFreeMode(void) {
	...
	// INH (SMBus Slave Inhibit) = SLAVE_ENABLED (Slave states are enabled.)
	*/
	SMB0CF = SMB0CF_SMBCS__TIMER1 | SMB0CF_ENSMB__ENABLED | SMB0CF_SMBFTE__FREE_TO_ENABLED
		 | SMB0CF_SMBTOE__SCL_TO_ENABLED | SMB0CF_EXTHOLD__ENABLED | SMB0CF_INH__SLAVE_ENABLED;
	// [SMB0CF - SMBus 0 Configuration]$
...
extern void TIMER01_0_enter_DefaultMode_from_BusFreeMode(void) {
	...
	/*
	// TH0 (Timer 0 High Byte) = 56
	*/
	TH0 = (56 << TH0_TH0__SHIFT);
	// [TH0 - Timer 0 High Byte]$

	// $[TL0 - Timer 0 Low Byte]
	/*
	// TL0 (Timer 0 Low Byte) = 19
	*/
	TL0 = (19 << TL0_TL0__SHIFT);
	// [TL0 - Timer 0 Low Byte]$
...
extern void INTERRUPT_0_enter_DefaultMode_from_BusFreeMode(void) {
	...
	*/
	EIP1 = EIP1_PADC0__LOW | EIP1_PWADC0__LOW | EIP1_PCP0__LOW | EIP1_PCP1__LOW
		 | EIP1_PMAT__LOW | EIP1_PPCA0__LOW | EIP1_PSMB0__HIGH | EIP1_PT3__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
