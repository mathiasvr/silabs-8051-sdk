...
extern void SMBUS_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	//     ignored.)
	// SLV (SMBus Hardware Slave Address) = 120
	*/
	SMB0ADR = SMB0ADR_GC__IGNORED | (120 << SMB0ADR_SLV__SHIFT);
	// [SMB0ADR - SMBus 0 Slave Address]$
	...
	// SLVM (SMBus Slave Address Mask) = 127
	*/
	SMB0ADM = SMB0ADM_EHACK__ADR_ACK_AUTOMATIC | (127 << SMB0ADM_SLVM__SHIFT);
	// [SMB0ADM - SMBus 0 Slave Address Mask]$
