...
extern void enter_LowPowerMode_from_RESET(void) {
	...
	PORTS_2_enter_LowPowerMode_from_RESET();
...
// PORTS_2_enter_LowPowerMode_from_RESET
//================================================================================
extern void PORTS_2_enter_LowPowerMode_from_RESET(void) {
	// $[P2 - Port 2 Pin Latch]
	// [P2 - Port 2 Pin Latch]$
...
extern void enter_HighCurrentMode_from_RESET(void) {
	...
	PORTS_2_enter_HighCurrentMode_from_RESET();
...
// PORTS_2_enter_HighCurrentMode_from_RESET
//================================================================================
extern void PORTS_2_enter_HighCurrentMode_from_RESET(void) {
	// $[P2 - Port 2 Pin Latch]
	// [P2 - Port 2 Pin Latch]$
