...
// Program Description:
//
// This program flashes the green LED on the EFM8SB2 MCU board about
...
//
// P2.0 - LED (push-pull output)
//
void Port_Init (void)
{
   P2MDOUT |= 0x01;                    // Enable LED as a push-pull output
