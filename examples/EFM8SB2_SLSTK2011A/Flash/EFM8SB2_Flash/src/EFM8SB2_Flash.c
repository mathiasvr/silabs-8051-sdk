...
// Program Description:
//
// This program tests all the functions available in EFM8SB2_FlashPrimitives.c
// and EFM8SB2_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8SB2 devices with less than 8 kB of memory will need to
...
#include "EFM8SB2_FlashPrimitives.h"
