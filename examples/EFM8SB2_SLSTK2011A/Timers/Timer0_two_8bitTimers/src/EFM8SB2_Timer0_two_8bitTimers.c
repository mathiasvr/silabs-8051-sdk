...
// Program Description:
//
// This program presents an example of use of the Timer0 of the EFM8SB2 in
// two 8-bit reload counter/timer mode. It uses the EFM8SB2DK as HW platform.
//
...
// reaching the value defined by LED1_TOGGLE_RATE toggles the LED1 pin.
//
// Pinout:
//
//    P2.0 -> LED0        (toggled by TL0)
//    P0.1 -> LED1    (toggled by TH0)
//
...
// 4) If a different LED1 toggle rate is desired change the following constant:
//       -> LED1_TOGGLE_RATE in Interrupts.c
// 5) Compile and download code to the EFM8SB2 STK board.
//    In Simplicity Studio IDE, select Run -> Debug from the menu bar,
//    click the Debug button in the quick menu, or press F11.
// 6) Run the code.
//    In Simplicity Studio IDE, select Run -> Resume from the menu bar,
//    click the Resume button in the quick menu, or press F8.
// 7) The LED0 should blink and LED1 should toggle.
//
// Target:         EFM8SB2
