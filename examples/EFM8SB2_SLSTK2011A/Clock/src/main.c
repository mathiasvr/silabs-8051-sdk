...
// Program Description:
//
// This program demonstrates a Clock on the EFM8SB2 STK using the
...
void AdjustTime()
{
    ...
    // Set P1.7 joystick to analog input
    // to read joystick positions
    P1MASK &= ~P1MASK_B7__COMPARED;
    P1MDIN &= ~P1MDIN_B7__BMASK;
    ...
    // Set P1.7 joystick back to digital input
