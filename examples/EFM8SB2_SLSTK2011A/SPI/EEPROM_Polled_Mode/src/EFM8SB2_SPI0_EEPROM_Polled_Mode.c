...
//    the end will print the test result as pass or fail. During write operations, LED0
//    will be on. During read operations, LED1 will be on. Additionally, if the
//    verification passes, LED0 will blink slowly. If it fails, LED0 will
//    be OFF, and LED2 will be on.
//
//
// Target:         EFM8SB2
...
SI_SBIT (LED0, SFR_P2, 0);                 // LED==LED_ON means ON
SI_SBIT (LED1, SFR_P2, 1);                 // LED==LED_ON means ON
SI_SBIT (LED2, SFR_P2, 2);                 // LED==LED_ON means ON
