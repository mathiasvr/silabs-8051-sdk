...
// Program Description:
//
// This program configures a EFM8SB2 as a 4-wire SPI Single Master.
//
...
// P2.0 - SPI NSS    (digital output, push-pull)
//
...
// 2) Connect the device to another EFM8 device running SPI0 - Slave code.
