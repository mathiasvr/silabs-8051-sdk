...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8SB2 STK (SPI Slave) + EFM8SB2 STK (SPI Master)
//-----------------------------------------------------------------------------
// 1) Connect the first EFM8SB2 STK SPI pins to the second EFM8SB2 STK running the
...
// 4) Compile and download code to the first EFM8SB2 STK board.
