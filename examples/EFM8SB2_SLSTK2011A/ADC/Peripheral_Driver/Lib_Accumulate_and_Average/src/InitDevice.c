...
extern void enter_AccumulateMode_from_RESET(void) {
	...
	PCACH_5_enter_AccumulateMode_from_RESET();
...
extern void PCACH_5_enter_AccumulateMode_from_RESET(void) {
	// $[PCA0 Settings Save]
...
extern void ADC_0_enter_AccumulateMode_from_RESET(void) {
	 ...
	 */
	ADC0AC = ADC0AC_ADRPT__ACC_32 | ADC0AC_ADAE__ACC_DISABLED
			| ADC0AC_ADSJST__RIGHT_SHIFT_3;
	// [ADC0AC - ADC0 Accumulator Configuration]$
...
extern void VREF_0_enter_AccumulateMode_from_RESET(void) {
	...
	REF0CN = REF0CN_TEMPE__TEMP_ENABLED | REF0CN_GNDSL__GND_PIN
			| REF0CN_REFOE__DISABLED | REF0CN_REFSL__HIGH_SPEED_VREF;
	// [REF0CN - Voltage Reference Control]$
...
extern void TIMER16_2_enter_AccumulateMode_from_RESET(void) {
	...
	/*
	 // TMR2RLL (Timer 2 Reload Low Byte) = 0x20
	 */
