...
// 5) Move the joystick. The LED will change color based on the joystick's position:
//      UP    - White
//      LEFT  - Blue
//      DOWN  - Green
//      RIGHT - Red
...
SI_SBIT(GREEN_LED, SFR_P2, 0);        // Green LED
SI_SBIT(BLUE_LED, SFR_P2, 1);         // Blue LED
SI_SBIT(RED_LED, SFR_P2, 2);          // Red LED
