...
extern void VREF_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 ...
	 //     is the GND pin.)
	 // REFOE (Internal Voltage Reference Output Enable) = ENABLED (Internal
	 //     1.68 V Precision Voltage Reference enabled and connected to VREF.)
	 // REFSL (Voltage Reference Select) = VREF_PIN (The ADC0 voltage
	 //     reference is the P0.0/VREF pin.)
	 */
	REF0CN = REF0CN_TEMPE__TEMP_ENABLED | REF0CN_GNDSL__GND_PIN
			| REF0CN_REFOE__ENABLED | REF0CN_REFSL__VREF_PIN;
	// [REF0CN - Voltage Reference Control]$
...
extern void TIMER16_3_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 // TMR3RLL (Timer 3 Reload Low Byte) = 0xF7
	 */
	TMR3RLL = (0xF7 << TMR3RLL_TMR3RLL__SHIFT);
	// [TMR3RLL - Timer 3 Reload Low Byte]$
