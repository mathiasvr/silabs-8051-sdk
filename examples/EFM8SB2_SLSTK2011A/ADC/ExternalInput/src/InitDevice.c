...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 0xFE
	*/
	...
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0xCE
	*/
	TMR2RLL = (0xCE << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	//     conversion signal.)
	*/
	ADC0CF = ADC0CF_AD8BE__NORMAL | ADC0CF_ADGN__GAIN_0P5 | (0x00 << ADC0CF_ADSC__SHIFT)
