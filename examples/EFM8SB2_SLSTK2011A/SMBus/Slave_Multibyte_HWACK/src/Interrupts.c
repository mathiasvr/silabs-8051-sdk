...
SI_INTERRUPT(SMBUS0_ISR, SMBUS0_IRQn)
{
  ...
  if (EXTHOLD_ENABLE)
  {
    if (first_entry)
    {
      ...
      TCON_TR0 = 0;                          // of a repeated start
      TCON_TF0 = 0;                          // Stop Timer0 and clear flag
    ...
    // Decode the SMBus status vector
    {
      ...
      case SMB_SRDB:
        ...
        if (rec_byte_counter < NUM_BYTES_WR)
        {
          ...
          SMB0CN0_ACK = 1;                // Auto-SMB0CN_ACK next data byte
        ...
        else  // (rec_byte_counter == NUM_BYTES_WR)
        {
          ...
          SMB0CN0_ACK = 0;                // Auto-NACK next data byte
        }
      ...
      case SMB_STDB:
        ...
        if (SMB0CN0_ACK == 1)      // If Master SMB0CN_ACK's, send the next byte
        {
