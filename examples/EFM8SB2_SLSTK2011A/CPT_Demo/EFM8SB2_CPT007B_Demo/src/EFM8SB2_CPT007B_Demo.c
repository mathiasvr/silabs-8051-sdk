...
// function board. This demo runs on the EFM8SB2 STK,and communicates
...
// P2.6 - Display enable
// P1.1 - CS00 GPIO input
// P1.3 - CS01 GPIO input
// P0.6 - CS02 GPIO input
// P0.7 - CS03 GPIO input
// P2.0 - CS04 GPIO input
// P2.1 - CS05 GPIO input
// P2.2 - CS06 GPIO input
