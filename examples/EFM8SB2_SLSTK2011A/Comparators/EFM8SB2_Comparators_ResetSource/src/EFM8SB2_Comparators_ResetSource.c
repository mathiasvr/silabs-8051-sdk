//-----------------------------------------------------------------------------
// EFM8SB2_Comparators_ResetSource.c
//-----------------------------------------------------------------------------
...
//   P0.6   - Comparator0 positive input (CP0+)
//   P2.0   - LED green
//   P2.6   - Display enable
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// 1) Connect P0.2 (push button) to P0.6 (comparator positive input) with an
//    external wire.
...
SI_SBIT (LED, SFR_P2, 0);              //  LED green
