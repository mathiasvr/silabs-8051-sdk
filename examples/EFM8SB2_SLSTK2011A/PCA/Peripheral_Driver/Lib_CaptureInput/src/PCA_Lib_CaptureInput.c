...
// by the definition T2_RELOAD_CLOCKS. This signal at P1.0 is provided simply
...
//   P2.6   - Display enable
//   P0.1   - PCA CEX0
//   P1.0   - Timer2 test output
//
//-----------------------------------------------------------------------------
// How To Test: EFM8SB2 STK
//-----------------------------------------------------------------------------
// 1) Short P0.1 and P1.0 together
...
// Alternately:
//
// 1) Run a bench signal generator into the P0.1 pin.
// 2) Place the switch in "AEM" mode.
// 3) Connect the EFM8SB2 STK board to a PC using a mini USB cable.
// 4) Compile and download code to the EFM8SB2 STK board.
//    In Simplicity Studio IDE, select Run -> Debug from the menu bar,
