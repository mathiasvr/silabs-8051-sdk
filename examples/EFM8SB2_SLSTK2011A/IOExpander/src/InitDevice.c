...
PORTS_1_enter_DefaultMode_from_RESET (void)
{
  ...
  // $[P1MASK - Port 1 Mask]
  /***********************************************************************
   - P1.0 pin logic value is compared to P1MAT.0
   - P1.1 pin logic value is compared to P1MAT.1
   - P1.2 pin logic value is compared to P1MAT.2
   - P1.3 pin logic value is compared to P1MAT.3
   ...
   ***********************************************************************/
  P1MASK = P1MASK_B0__COMPARED | P1MASK_B1__COMPARED | P1MASK_B2__COMPARED
      | P1MASK_B3__COMPARED | P1MASK_B4__COMPARED | P1MASK_B5__COMPARED
