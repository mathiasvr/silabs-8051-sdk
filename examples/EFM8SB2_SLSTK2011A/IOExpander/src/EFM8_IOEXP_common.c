...
//   P0.6   - SMBus SDA
//   P0.7   - SMBus SCL
//   P2.3   - Address extension (default address increased by 1 if connected to
//            GND)
//   P2.5   - IRQ (goes to GND if state of input pins are changing)
//
//-----------------------------------------------------------------------------
// How To Test: EFM8SB2 STK (SMBus GPIO Expander) + EFR32 STK (Command
// Interpreter/SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device EFM8SB2 STK to EFR32 STK running the corresponding
//    I2C CLI code.
