...
extern void enter_SlowBlink_from_RESET(void) {
	...
	PORTS_2_enter_SlowBlink_from_RESET();
...
extern void enter_FastBlink_from_RESET(void) {
	...
	PORTS_2_enter_FastBlink_from_RESET();
...
extern void enter_SlowBlink_WD_from_SlowBlink(void) {
	...
	PCACH_5_enter_SlowBlink_WD_from_SlowBlink();
	// Restore the SFRPAGE
	SFRPAGE = SFRPAGE_save;
	// [Config Calls]$
...
extern void PCA_0_enter_SlowBlink_WD_from_SlowBlink(void) {
	// $[PCA0MD - PCA Mode]
	/*
	// WDTE (Watchdog Timer Enable) = ENABLED (Enable PCA Module 5 as the
	//     Watchdog Timer.)
	// CPS (PCA Counter/Timer Pulse Select) = SYSCLK_DIV_12 (System clock
	//     divided by 12.)
	// CIDL (PCA Counter/Timer Idle Control) = NORMAL (PCA continues to
...
extern void PCACH_5_enter_SlowBlink_WD_from_SlowBlink(void) {
	...
	*/
	...
	/*
	// PCA0CPL5 (PCA Channel 5 Capture Module Low Byte) = 0xFF
	*/
	PCA0CPL5 = (0xFF << PCA0CPL5_PCA0CPL5__SHIFT);
	// [PCA0CPL5 - PCA Channel 5 Capture Module Low Byte]$

	// $[PCA0CPH5 - PCA Channel 5 Capture Module High Byte]
	/*
	// PCA0CPH5 (PCA Channel 5 Capture Module High Byte) = 0xFF
	*/
	PCA0CPH5 = (0xFF << PCA0CPH5_PCA0CPH5__SHIFT);
	// [PCA0CPH5 - PCA Channel 5 Capture Module High Byte]$
