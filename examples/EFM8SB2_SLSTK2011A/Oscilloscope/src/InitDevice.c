...
extern void PORTS_1_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	//     digital mode.)
	// B3 (Port 1 Bit 3 Input Mode) = ANALOG (P1.3 pin is configured for
	//     analog mode.)
...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	ADC0AC = ADC0AC_ADRPT__ACC_1 | ADC0AC_ADAE__ACC_DISABLED | ADC0AC_ADSJST__LEFT_NO_SHIFT;
	// [ADC0AC - ADC0 Accumulator Configuration]$
	...
	//     conversion signal.)
	*/
	ADC0CF = ADC0CF_AD8BE__8_BIT | ADC0CF_ADGN__GAIN_0P5 | (0x03 << ADC0CF_ADSC__SHIFT)
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// PADC0 (ADC0 Conversion Complete Interrupt Priority Control) = HIGH
	//     (ADC0 Conversion Complete interrupt set to high priority level.)
	// PWADC0 (ADC0 Window Comparator Interrupt Priority Control) = HIGH
	...
	*/
	EIP1 = EIP1_PADC0__HIGH | EIP1_PWADC0__HIGH | EIP1_PCP0__LOW | EIP1_PCP1__LOW
		 | EIP1_PPCA0__LOW | EIP1_PRTC0A__LOW | EIP1_PSMB0__LOW | EIP1_PT3__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
