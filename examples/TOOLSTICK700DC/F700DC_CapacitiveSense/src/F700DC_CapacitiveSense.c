...
// one of the two touch sense buttons on the C8051F700 daughter card
...
// How To Test:
//
// 1) Connect the ToolStickF700DC to a ToolStick Base Adapter.
...
// 4) Press the switches to change the brightness of the LED.
//
// Target:         C8051F70x
...
// P1.1   digital   open-drain    Push-button Switch
// P2.0   analog                  Capacitive Switch
// P2.1   analog                  Capacitive Switch
//-----------------------------------------------------------------------------
void PORT_Init (void)
{
   uint8_t SFRPAGE_save = SFRPAGE;          // Save the current SFRPAGE
   ...
   P2MDIN &= ~0x03;                    // P2.0-P2.1 set to analog input for 
                                       // CS0
...
void CS0_Init (void)
{
   ...
   CS0SS = 0x00;                       // Set channel 0 as autoscan 
                                       // starting channel
   CS0SE = 0x01;                       // Set channel 1 as autoscan end channel
