...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F32x MCU
...
// connections of the 'F32x MCU are shown here:
//
...
//
// Method1:
// 1) Download the code to a 'F32x device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F32x device that is connected as above, and
...
//-----------------------------------------------------------------------------
// 16-bit SFR Definitions for the 'F32x
//-----------------------------------------------------------------------------
