...
// be indicated by the LED's labelled Pw.3 and P2.2 on the C8051F340 Target Board.
//
// Resources:
...
//
//-----------------------------------------------------------------------------
// How To Test: C8051F340-TB
//-----------------------------------------------------------------------------
// 1) Plug the USB Debug Adapter into the port labelled DEBUG.
// 2) Power the C8051F340-TB at P1.
// 3) Attach a USB cable between the target PC and P3 of the C8051F340-TB.
// 4) Compile and download code to the C8051F340 Target Board.
