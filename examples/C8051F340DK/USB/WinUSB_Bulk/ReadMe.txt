...
2.0 Running the Example on the C8051F340 target board
-----------------------------------------------------
	...
	1) Connect the hardware:
		...
		b) Install shorting blocks at the following positions: 
		   J12[5-6] (P2.2 LED) and J12[7-8] (P2.3 LED).
	...
	2) Build and download the Bulk Example firmware:
		...
		c) Connect to the target C8051F34x device (Alt+C, or IDE menu 
		   Debug->Connect).

		d) From the Project menu, select "Open Project" and browse to the 
		   Bulk Example Firware project "F340_USB0_Bulk.wsp", located by
           default in the "Silabs\MCU\Examples\C8051F34x\USB_Bulk\Firmware"
           directory.
