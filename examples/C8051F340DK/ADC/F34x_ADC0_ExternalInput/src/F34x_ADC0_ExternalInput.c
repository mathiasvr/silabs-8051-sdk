...
// 4) Connect serial cable from P4 to a PC
// 5) Run the code by selecting Run -> Resume from the menus, clicking the
//    Resume button in the quick menu, or pressing F8.
// 6) On the PC, open HyperTerminal (or any other terminal program) and connect
//    to the COM port at <BAUDRATE> and 8-N-1
// 7) Connect a variable voltage source (between 0 and Vref)
//    to P1.1, or a potentiometer voltage divider as shown above.
//    If using the on-board potentiometer, make sure that J17 and J16 jumpers
//    populated, then connect P1.1 to P2.5.
...
void PORT_Init (void)
{
   ...
   P1MDIN &= ~0x22;                    // set P1.1 and P1.5 as an analog input
}
