...
// 2) On the target board, connect P2.0_SW and P2.1_SW signals on J12 to P0.0
...
SI_SBIT(SW1, SFR_P2, 0);                      // Push-button switch on board
SI_SBIT(SW2, SFR_P2, 1);                      // Push-button switch on board
SI_SBIT(LED1, SFR_P2, 2);                      // Green LED='1' means ON
SI_SBIT(LED2, SFR_P2, 3);                      // Green LED='1' means ON
