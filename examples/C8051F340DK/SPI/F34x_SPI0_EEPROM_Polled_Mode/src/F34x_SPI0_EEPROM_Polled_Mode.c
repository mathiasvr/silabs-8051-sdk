...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F34x MCU
...
// connections of the 'F34x MCU are shown here:
//
...
//
// Method2 (optional):
// 1) Download code to a 'F34x device that is connected as above, and
