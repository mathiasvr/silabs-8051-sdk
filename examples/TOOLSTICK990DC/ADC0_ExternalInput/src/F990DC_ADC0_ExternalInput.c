...
// P0.6 (Potentiometer input) using ADC0. This measurement can be viewed by
...
SI_SBIT(R15_ENABLE, SFR_P1, 5);          // Open-Drain output. Write '0' to 
...
SI_INTERRUPT(ADC_ISR, ADC0EOC_IRQn)
{
   ...
   if(measurements == 0)
   {
      ...
      printf("P0.6 voltage: %d mV", (uint16_t) mV); // <--- Place break-point here
   }
}
