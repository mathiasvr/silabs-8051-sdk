...
// P1.6 using ADC0, then prints the results to a terminal window via the UART.
//
...
//
// The analog multiplexer selects P1.6 as the positive ADC0 input.  This
...
// VREF (2.40V) and AGND on the terminal strip as shown below:
//
// ---------
//          |
//         o| VREF ----|
...
// How To Test:
// ------------
// 1) Download code to a 'F338 device on a C8051F338-TB development board
...
// 4) Connect a variable voltage source between 0V and Vref(2.4V in this example)
//    to P1.6, or a potentiometer voltage divider as shown above.
...
//    - Modified Port configuration to use P1.6 for ADC0 analog input on F338-TB.
//    - 25 JAN 2014
//
// Release 1.0
//    -Initial Revision (SM)
...
void PORT_Init (void)
{
   ...
   P1MDIN &= ~0x40;                    // set P1.6 as an analog input
}
...
void ADC0_Init (void)
{
   ...
   AMX0P = 0x0E;                       // ADC0 positive input = P1.6
...
SI_INTERRUPT(ADC_ISR, ADC0EOC_IRQn)
{
   ...
   if(measurements == 0)
   {
      ...
      // The measured voltage applied to P1.6 is then:
      //
      //                           Vref (mV)
