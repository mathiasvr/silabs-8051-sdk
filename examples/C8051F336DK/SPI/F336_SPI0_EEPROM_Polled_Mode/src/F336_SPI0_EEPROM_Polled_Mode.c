...
// connections of the 'F336 MCU are shown here:
//
...
//
// Method1:
// 1) Download the code to a 'F336 device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F336 device that is connected as above
