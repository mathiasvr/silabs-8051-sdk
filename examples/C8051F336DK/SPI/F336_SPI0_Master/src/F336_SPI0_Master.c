...
// Program Description:
//
// This program configures a C8051F336 as a 4-wire SPI Single Master.
//
...
// How To Test:
//
// 1) Download the code to a F338-TB that is connected as above to
//    another device running the SPI0_Slave code.
// 2) Verify that the J5 and J6 jumper is not populated.
// 3) Verify the LED pin of jumper J3 is populated.
// 4) Run the code.
