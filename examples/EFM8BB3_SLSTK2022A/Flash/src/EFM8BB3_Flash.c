...
// Program Description:
//
// This program tests all the functions available in EFM8BB3_FlashPrimitives.c
// and EFM8BB3_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8BB3 devices with less than 64 kB of memory will need to
