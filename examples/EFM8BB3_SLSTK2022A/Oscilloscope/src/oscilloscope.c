...
void EnableJoystickInput()
{
    ...
    ADC0CF2 = (ADC0CF2 & ~ADC0CF2_REFSL__FMASK) | ADC0CF2_REFSL__VDD_PIN;

    // Switch ADC gain to 1x
    ADC0CN0 = (ADC0CN0 & ~ADC0CN0_ADGN__FMASK) | ADC0CN0_ADGN__GAIN_1;
...
void DisableJoystickInput()
{
    ...
    ADC0CF2 = (ADC0CF2 & ~ADC0CF2_REFSL__FMASK) | ADC0CF2_REFSL__INTERNAL_VREF;

    // Switch ADC gain back to 0.5x
    ADC0CN0 = (ADC0CN0 & ~ADC0CN0_ADGN__FMASK) | ADC0CN0_ADGN__GAIN_0P5;
...
void ApplyMenuSettings()
{
    ...
    switch (AnalogInput)
    {
    case INPUT_JOY:     ADC0MX = ADC0MX_ADC0MX__ADC0P13;    break;
...
void DrawWaveform()
{
    ...
    for (i = 0; i < DISP_HEIGHT; i++)
    {
        ...
        if (ShowLabels == SHOW_LABELS_ON)
        {
            ...
            // Render window period (256us - 4096us)
