...
#if defined(DEVICE_PKG_QFN32) || defined(DEVICE_PKG_QFP32) || defined(DEVICE_PKG_5QFN32)
#define BL_START_PIN P3_B7

#elif defined(DEVICE_PKG_QFN24) || defined(DEVICE_PKG_QSOP24) || defined(DEVICE_PKG_4QFN24)
