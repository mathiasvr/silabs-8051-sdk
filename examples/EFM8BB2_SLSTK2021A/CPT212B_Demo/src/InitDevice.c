...
extern void PCACH_2_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - PCA Channel 2 Capture Module Low Byte = 0xC9
	 ***********************************************************************/
	PCA0CPL2 = (0xC9 << PCA0CPL2_PCA0CPL2__SHIFT);
	// [PCA0CPL2 - PCA Channel 2 Capture Module Low Byte]$

	// $[PCA0CPH2 - PCA Channel 2 Capture Module High Byte]
	/***********************************************************************
	 - PCA Channel 2 Capture Module High Byte = 0x04
	 ***********************************************************************/
	PCA0CPH2 = (0x04 << PCA0CPH2_PCA0CPH2__SHIFT);
	// [PCA0CPH2 - PCA Channel 2 Capture Module High Byte]$
