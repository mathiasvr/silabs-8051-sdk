//-----------------------------------------------------------------------------
// EFM8BB2_Comparators_ResetSource.c
//-----------------------------------------------------------------------------
...
//    external wire.
// 3) Place the switch in "AEM" mode.
// 4) Connect the EFM8BB2 STK board to a PC using a mini USB cable.
// 5) Compile and download code to the EFM8BB2 STK board.
...
// 9) Verify that the green LED is blinking.
//
// Target:         EFM8BB2
// Tool chain:     Generic
//
