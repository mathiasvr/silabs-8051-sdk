...
//   P2.1   - SMBus SDA
//   P2.2   - SMBus SCL
//   P2.0   - Address extension (default address increased by 1 if connected to
//            GND)
//   P3.1   - IRQ (goes to GND if state of input pins are changing)
//
//-----------------------------------------------------------------------------
// How To Test: EFM8BB2 STK (SMBus GPIO Expander) + EFR32 STK (Command
// Interpreter/SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device EFM8BB2 STK to EFR32 STK running the corresponding
//    I2C CLI code.
