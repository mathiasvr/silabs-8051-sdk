//-----------------------------------------------------------------------------
// F381DC_USB0_Standard_Requests.c
//-----------------------------------------------------------------------------
...
// Project Name:   F381DC_FirmwareTemplate
//
//
// Release 1.2 (BL)
...
//
// Release 1.1
//    - Minor changes to F381DC_USB0_Descriptor.c
//    - 16 NOV 2006
// Release 1.0
//    -Initial Revision (PD)
//    -07 DEC 2005
...
#include "F381DC_USB0_Register.h"
#include "F381DC_USB0_InterruptServiceRoutine.h"
#include "F381DC_USB0_Descriptor.h"
#include "F381DC_USB0_ReportHandler.h"

//-----------------------------------------------------------------------------
// Variables
//-----------------------------------------------------------------------------
extern device_descriptor code DEVICEDESC;   // These are created in F381DC_USB0_Descriptor.h
extern uint8_t * STRINGDESCTABLE[];
...
code uint8_t ONES_PACKET[2] = {0x01, 0x00};
// Communication with host
code uint8_t ZERO_PACKET[2] = {0x00, 0x00};
