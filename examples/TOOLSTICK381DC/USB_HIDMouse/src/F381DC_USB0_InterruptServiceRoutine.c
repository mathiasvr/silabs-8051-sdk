//-----------------------------------------------------------------------------
// F381DC_USB0_InterruptServiceRoutine.c
//-----------------------------------------------------------------------------
...
uint8_t USB0_STATE;               // Holds the current USB State
                                       // def. in F381DC_USB0_InterruptServiceRoutine.h
...
void SendPacket (uint8_t ReportID)
{
   bit EAState;
   uint8_t ControlReg;
