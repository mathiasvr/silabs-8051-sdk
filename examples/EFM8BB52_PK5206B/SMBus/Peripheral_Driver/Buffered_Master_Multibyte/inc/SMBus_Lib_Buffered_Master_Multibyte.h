...
#ifndef __SMBUS_LIB_BUFFERED_MASTER_MULTIBYTE_H__
#define __SMBUS_LIB_BUFFERED_MASTER_MULTIBYTE_H__
...
extern SI_SEGMENT_VARIABLE(SMB_DATA_IN[NUM_BYTES_RD], uint8_t, EFM8PDL_SMB0_RX_BUFTYPE);
...
#endif // __SMBUS_LIB_BUFFERED_MASTER_MULTIBYTE_H__
