...
extern void enter_BusFreeMode_from_RESET(void) {
  ...
  PORTS_3_enter_BusFreeMode_from_RESET();
...
//================================================================================
// PORTS_1_enter_BusFreeMode_from_BusFreeMode
//================================================================================
extern void PORTS_1_enter_BusFreeMode_from_RESET(void) {
  ...
  /*
   ...
   //     float high.)
   // B5 (Port 1 Bit 5 Latch) = HIGH (P1.5 is high. Set P1.4 to drive or
   //     float high.)
   // B6 (Port 1 Bit 6 Latch) = HIGH (P1.6 is high. Set P1.4 to drive or
   //     float high.)
...
// PORTS_3_enter_BusFreeMode_from_RESET
//================================================================================
extern void PORTS_3_enter_BusFreeMode_from_RESET(void) {
  // $[P3 - Port 3 Pin Latch]
  // [P3 - Port 3 Pin Latch]$
