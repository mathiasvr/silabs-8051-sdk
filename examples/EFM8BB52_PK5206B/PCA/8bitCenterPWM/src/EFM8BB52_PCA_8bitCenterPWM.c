...
//
// In this example, PCA0 channels 0 and 1 are used to generate the waveforms, 
// and the crossbar is configured to send the CEX0 signal out on P1.5 (LED_B) and the
// CEX1 signal out on P1.6 (LED_R).
//
// Resources:
...
// 5) Place an oscilloscope probe on P1.5 and P1.6.  Channel 0 and 1 output can
//    also be visualized on BRD5206B LED_B and LED_R.
