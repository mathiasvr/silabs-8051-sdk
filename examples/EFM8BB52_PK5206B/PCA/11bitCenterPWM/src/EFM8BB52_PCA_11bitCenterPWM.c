...
// the crossbar is configured to send the CEX0 signal out on P1.5 (LED_B).
//
// Resources:
...
// 5) Place an oscilloscope probe on P1.5. Output can also be visualized on
//    LED_B.
