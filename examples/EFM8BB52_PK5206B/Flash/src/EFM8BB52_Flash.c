...
// Program Description:
//
// This program tests all the functions available in EFM8BB52_FlashPrimitives.c
// and EFM8BB52_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: This example is written for EFM8BB52 devices with 32KB flash. To port
...
SI_SBIT (LED, SFR_P1, 4);              // Green LED
#define LED_ON   0
#define LED_OFF  1
...
void main (void)
{
  ...
  /* REMOVE READLIM WRITE IF NOT TURIN A0 */
  // Validation DSR for A0 does not write to READLIM
  // READLIM has to be written at least once
  // Otherwise bootloader is considered locked.
  READLIM = 0xFF;
