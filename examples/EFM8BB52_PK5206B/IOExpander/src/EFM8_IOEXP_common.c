...
//   P2.0   - SMBus SDA
//   P2.1   - SMBus SCL
//   P2.2   - Address extension (default address increased by 1 if connected to
//            GND)
//   P2.3   - IRQ (goes to GND if state of input pins are changing)
//
//-----------------------------------------------------------------------------
// How To Test: EFM8BB52 PK (SMBus GPIO Expander) + EFR32 STK (Command
// Interpreter/SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device EFM8BB52 PK to EFR32 STK running the corresponding
//    I2C CLI code.
// 2) Place the switch in "AEM" mode.
// 3) Connect the EFM8BB52 PK board to a PC using a USB cable.
// 4) Compile and download code to the EFM8BB52 PK board.
