...
pin_test:
    ...
    MOV     P2MDIN,#01H             ; P2.0 boot pin is configured for digital mode for 20-pin packages
#else
    MOV     P3MDIN,#80H             ; P3.7 boot pin is configured for digital mode for 28-pin and 32-pin packages
#endif
    MOV     SFRPAGE,#00H
    ANL     A,#03H                  ; A = RSTSRC
