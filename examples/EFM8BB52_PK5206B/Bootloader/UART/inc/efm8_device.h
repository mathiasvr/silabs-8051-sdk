...
#else
#include "SI_EFM8BB52_Defs.inc"
#endif

// Select the PK device if one has not been specified by the project
#ifndef EFM8BB52_DEVICE
#define EFM8BB52_DEVICE EFM8BB52F32I_QFN32
#endif
#include "SI_EFM8BB52_Devices.h"
...
#elif defined(DEVICE_PKG_QFN32) || defined(DEVICE_PKG_TSSOP28)
