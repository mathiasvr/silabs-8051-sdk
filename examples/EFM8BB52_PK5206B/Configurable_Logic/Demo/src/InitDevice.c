...
extern void PORTS_3_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 ...
	 //     drain.)
	 // B3 (Port 3 Bit 3 Output Mode) = PUSH_PULL (P3.3 output is push-pull.)
	...
	/*
	 ...
	 //     digital mode.)
	 // B7 (Port 3 Bit 7 Input Mode) = ANALOG (P3.7 pin is configured for
	 //     analog mode.)
	 */
	...
	/*
	 ...
	 //     crossbar.)
	 // B3 (Port 3 Bit 3 Skip) = SKIPPED (P3.3 pin is skipped by the
	 //     crossbar.)
	 */
...
extern void CLU_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 // FNSEL (CLU Look-Up-Table function select) = 0xC0
	 */
	SFRPAGE = 0x20;
	CLU0FN = (0xC0 << CLU0FN_FNSEL__SHIFT);
	// [CLU0FN - Configurable Logic Unit 0 Function Select]$
