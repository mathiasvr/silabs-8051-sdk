...
extern void PORTS_0_enter_DefaultMode_from_RESET(void)
{
    ...
    /*
     ...
     //     drain.)
     // B2 (Port 0 Bit 2 Output Mode) = OPEN_DRAIN (P0.2 output is open-drain.)
     ...
     //     drain.)
     // B6 (Port 0 Bit 6 Output Mode) = OPEN_DRAIN (P0.6 output is push-pull.)
...
extern void PORTS_1_enter_DefaultMode_from_RESET(void)
{
    ...
    /*
     ...
     // B1 (Port 1 Bit 1 Output Mode) = OPEN_DRAIN (P1.1 output is open-drain.)
...
extern void PORTS_2_enter_DefaultMode_from_RESET(void)
{
    ...
    /*
     ...
     // B1 (Port 2 Bit 1 Output Mode) = OPEN_DRAIN (P2.1 output is open-drain.)
     ...
     //     drain.)
     // B5 (Port 2 Bit 5 Output Mode) = PUSH_PULL (P2.5 output is push-pull.)
    ...
    /*
     ...
     //     ignored and will not cause a port mismatch event.)
     // B4 (Port 2 Bit 4 Mask Value) = IGNORED (P2.4 pin logic value is
     //     ignored and will not cause a port mismatch event.)
     // B5 (Port 2 Bit 5 Mask Value) = IGNORED (P2.5 pin logic value is
     //     ignored and will not cause a port mismatch event.)
     // B6 (Port 2 Bit 6 Mask Value) = IGNORED (P2.6 pin logic value is
     //     ignored and will not cause a port mismatch event.)
     // B7 (Port 2 Bit 7 Mask Value) = IGNORED (P2.7 pin logic value is
     //     ignored and will not cause a port mismatch event.)
     */
    P2MASK = P2MASK_B0__IGNORED | P2MASK_B1__IGNORED | P2MASK_B2__IGNORED
            | P2MASK_B3__IGNORED | P2MASK_B4__IGNORED | P2MASK_B5__IGNORED
            | P2MASK_B6__IGNORED | P2MASK_B7__IGNORED;
    // [P2MASK - Port 2 Mask]$
    ...
    /*
     ...
     //     with logic HIGH.)
     // B4 (Port 2 Bit 4 Match Value) = HIGH (P2.4 pin logic value is compared
     //     with logic HIGH.)
     // B5 (Port 2 Bit 5 Match Value) = HIGH (P2.5 pin logic value is compared
     //     with logic HIGH.)
     // B6 (Port 2 Bit 6 Match Value) = HIGH (P2.6 pin logic value is compared
     //     with logic HIGH.)
     // B7 (Port 2 Bit 7 Match Value) = HIGH (P2.7 pin logic value is compared
     //     with logic HIGH.)
     */
    P2MAT = P2MAT_B0__HIGH | P2MAT_B1__HIGH | P2MAT_B2__HIGH | P2MAT_B3__HIGH
            | P2MAT_B4__HIGH | P2MAT_B5__HIGH | P2MAT_B6__HIGH | P2MAT_B7__HIGH;
    // [P2MAT - Port 2 Match]$
