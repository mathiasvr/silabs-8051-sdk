//-----------------------------------------------------------------------------
// EFM8BB52_Configurable_Logic_Lib_AND.c
//-----------------------------------------------------------------------------
...
// one-output AND gate using the CLU Peripheral Driver Library.
//
...
//   |    0     0    x  |     0     |
//   |    0     0    x  |     0     |
//                            ^--- 0xC0 = CLUnFN setting to implement this
//                                        look up table
//   x is don't care
//
// Resources:
...
SI_SBIT(LED0, SFR_P1, 4);// P1.4 Green LED
#define LED_ON  0
#define LED_OFF 1
...
void main (void)
{
   ...
   // Set output function to A AND B
