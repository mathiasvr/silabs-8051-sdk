...
extern void PORTS_2_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   ...
   //     crossbar.)
   // B1 (Port 2 Bit 1 Skip) = SKIPPED (P2.1 pin is not skipped by the
   //     crossbar.)
   // B2 (Port 2 Bit 2 Skip) = SKIPPED (P2.2 pin is not skipped by the
   //     crossbar.)
   // B3 (Port 2 Bit 3 Skip) = SKIPPED (P2.3 pin is not skipped by the
   //     crossbar.)
   */
...
extern void PORTS_3_enter_DefaultMode_from_RESET(void) {
  // $[P3 - Port 3 Pin Latch]
  /*
   // B0 (Port 3 Bit 0 Latch) = HIGH (P2.0 is high. Set P2.0 to drive or
   //     float high.)
   // B1 (Port 3 Bit 1 Latch) = HIGH (P2.1 is high. Set P2.1 to drive or
   //     float high.)
   // B2 (Port 3 Bit 2 Latch) = HIGH (P2.2 is high. Set P2.2 to drive or
   //     float high.)
   // B3 (Port 3 Bit 3 Latch) = HIGH (P2.3 is high. Set P2.3 to drive or
   //     float high.)
   // B4 (Port 3 Bit 4 Latch) = HIGH (P2.4 is high. Set P2.4 to drive or
   //     float high.)
   // B7 (Port 3 Bit 7 Latch) = HIGH (P2.7 is high. Set P2.7 to drive or
   //     float high.)
   */
