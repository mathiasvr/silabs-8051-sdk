//-----------------------------------------------------------------------------
// EFM8BB52_PWM_Hardware_Trigger.c
//-----------------------------------------------------------------------------
...
// 6) Press BTN0 to drive the CLU2 output high and trigger the PWM. The red and
//    green LEDs should both turn on with a 50% duty cycle, resulting in a 
//    yellow output color.
...
// 8) In addition to visually viewing the LED, connect oscilloscope
//    probes to P1.4 and P1.6 to view the PWM waveforms
//    on a scope.
//
// Target:         EFM8BB52
// Tool chain:     Generic
...
void initPWM(void)
{
   ...
   * CH0x = 1 and CH1x = 1
   */
  PWMCFG3 = PWMCFG3_CH0XSAFST__SAFE1 | PWMCFG3_CH1XSAFST__SAFE1;
