//-----------------------------------------------------------------------------
// EFM8BB52_PWM_Differential_DTI_Kill.c
//-----------------------------------------------------------------------------
...
// 5) Initially, the blue and green LEDs will alternate brightness as the
//    CH0 PWM duty cycle is updated at a 20 Hz interval.
...
//    corresponds to the green LED on and the blue LED off.
...
// 9) In addition to visually viewing the changing duty cycle on the green and
//    blue LEDs, connect oscilloscope probes to P1.4 and P1.5 to view the PWM
...
void initPWM(void)
{
  ...
  */
   ...
   * CH0x = 0 and CH0y = 1
   */
  PWMCFG3 = PWMCFG3_CH0XSAFST__SAFE0 | PWMCFG3_CH0YSAFST__SAFE1;
