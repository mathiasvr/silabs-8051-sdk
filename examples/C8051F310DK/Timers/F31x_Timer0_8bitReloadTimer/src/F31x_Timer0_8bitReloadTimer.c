...
// 8-bit counter/timer with reload mode. It uses the 'F310DK as HW platform.
...
// 6) Check the toggling of the LED (P3.3)
//
//
// Target:         C8051F31x
