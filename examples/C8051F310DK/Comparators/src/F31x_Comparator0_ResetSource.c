...
// 2) On the target board, connect P1.0 to P0.7 and P1.1 to P3.3
// 4) Compile and download code to the C8051F310-TB development board by selecting
//    Run -> Debug from the menus, clicking the Debug button in the quick menu,
//    or pressing F11.
// 5) Run the code by selecting Run -> Resume from the menus, clicking the
//    Resume button in the quick menu, or pressing F8. Verify that the LED is
//    On.
// 6) Press the P0.7 switch (this causes a comparator reset)
...
SI_SBIT(SWITCH, SFR_P0, 7);               // Push-button switch on board
...
void PORT_Init (void)
{
   ...
   P1MDIN  &= ~0x03;                   // Comparator 0 inputs (P1.0 and P1.1)
                                       // are analog inputs.
   P3MDOUT  = 0x08;                    // LED is push-pull output
}
