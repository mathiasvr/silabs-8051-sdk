...
// Program Description:
//
// This program configures a C8051F31x as a SPI Slave. The 'F31x MCU
...
// Pinout:
//
// P0.0 - SPI SCK    (digital output, open-drain)
// P0.1 - SPI MISO   (digital input, push-pull)
// P0.2 - SPI MOSI   (digital output, open-drain)
// P0.3 - SPI NSS    (digital output, push-pull)
//
// P3.3 - LED        (digital output, open-drain)
//
