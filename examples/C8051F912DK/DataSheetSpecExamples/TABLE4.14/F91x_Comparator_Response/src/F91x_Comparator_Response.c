...
//
// Refer to F91x_Comparator_Response_Readme.txt for more information regarding
...
//    time from P0.0 toggled to P0.3 toggled is response time on datasheet
//    for the CP0 in Table 4.14
//
