...
//
// Refer to F91x_Comparator_Hysteresis_Readme.txt for more information regarding
...
// 5) Download and run the code on a C8051F912-TB target board.
...
// 8) CP0 negative input is digital supply 1.8v. Use a voltage supply to sweep
