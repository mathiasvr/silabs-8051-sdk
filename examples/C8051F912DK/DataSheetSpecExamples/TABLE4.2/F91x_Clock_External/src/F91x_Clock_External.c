...
//
// Refer to F91x_Clock_External_Readme.txt for more information regarding this
...
// 6) Compile and download code to a 'F91x device on a C8051F912-TB development
