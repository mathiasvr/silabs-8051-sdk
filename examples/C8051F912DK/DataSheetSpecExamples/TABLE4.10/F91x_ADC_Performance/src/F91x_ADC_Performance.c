...
//
// Refer to F91x_ADC_Performance_Readme.txt for more information
// regarding this code example's functionality.
//
//
// How to Measure (Table 4.10 - SNR):
// ----------------------------------------------------
// 1) Ensure that shorting blocks on a C8051F912-TB are attached to the J17
...
// 9) Open F91x_ADC_Performance_SNR.xlsx and follow the directions inside
...
void main (void)
{
    ...
    printf("\n");
    printf("--------------------------\n");
    printf("F91x ADC Performance Test \n");
    printf("--------------------------\n");
    printf("\n");
    ...
    while (1)
    {
        ...
        while( !inputLatch )
        {
            ...
            printf("-------------------------------------------------------------\n");
            printf("To sample data on P0.0 using ADC 10-bit mode, please press 1 \n");
            printf("To sample data on P0.0 using ADC 12-bit mode, please press 2 \n");
            printf("To measure Offset Error of ADC 10-bit mode, please press 3 \n");
            printf("To measure Offset Error of ADC 12-bit mode, please press 4 \n");
        ...
        case '2':
                ...
                printf("F91x_ADC_Performance_SNR.xlsx to calculate SNR. \n");
                break;
