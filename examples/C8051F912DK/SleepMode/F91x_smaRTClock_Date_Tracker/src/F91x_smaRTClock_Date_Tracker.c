...
// Program Description:
//
// This program will keep track of the date and time and output both to a 
// terminal program. The initial date and time can be set by changing
...
void RTC_Init (void)
{
   uint16_t i;                              // Counter used in for loop

   SI_UU32_t alarm_interval_first;          // Stores first alarm value
