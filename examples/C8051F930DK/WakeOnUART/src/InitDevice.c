...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TH1 (Timer 1 High Byte) = 44
	*/
	TH1 = (44 << TH1_TH1__SHIFT);
	// [TH1 - Timer 1 High Byte]$

	// $[TL1 - Timer 1 Low Byte]
	/*
	// TL1 (Timer 1 Low Byte) = 44
	*/
	TL1 = (44 << TL1_TL1__SHIFT);
	// [TL1 - Timer 1 Low Byte]$
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TMR2H (Timer 2 High Byte) = 248
	*/
	TMR2H = (248 << TMR2H_TMR2H__SHIFT);
	// [TMR2H - Timer 2 High Byte]$

	// $[TMR2L - Timer 2 Low Byte]
	/*
	// TMR2L (Timer 2 Low Byte) = 6
	*/
	TMR2L = (6 << TMR2L_TMR2L__SHIFT);
	// [TMR2L - Timer 2 Low Byte]$

	// $[TMR2RLH - Timer 2 Reload High Byte]
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 248
	*/
	TMR2RLH = (248 << TMR2RLH_TMR2RLH__SHIFT);
	// [TMR2RLH - Timer 2 Reload High Byte]$

	// $[TMR2RLL - Timer 2 Reload Low Byte]
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 6
	*/
	TMR2RLL = (6 << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
...
extern void DCDC_0_enter_DefaultMode_from_RESET(void) {
	...
	// SWSEL (DC-DC Converter Switch Select) = SMALL (The small switches are
	//     selected (best efficiency for low output currents).)
	...
	*/
	DC0CN = DC0CN_VSEL__OUTPUT_3P0 | DC0CN_SWSEL__SMALL | DC0CN_MINPW__NO_MINIMUM
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	EIE2 = EIE2_EMAT__ENABLED | EIE2_ERTC0F__DISABLED | EIE2_ESPI1__DISABLED
