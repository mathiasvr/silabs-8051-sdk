...
extern void PBCFG_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	XBR1 = XBR1_SPI1E__DISABLED | XBR1_PCA0ME__DISABLED | XBR1_ECIE__DISABLED
		 | XBR1_T0E__ENABLED | XBR1_T1E__DISABLED;
	// [XBR1 - Port I/O Crossbar 1]$
...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TH0 (Timer 0 High Byte) = 252
	*/
	TH0 = (252 << TH0_TH0__SHIFT);
	// [TH0 - Timer 0 High Byte]$

	// $[TL0 - Timer 0 Low Byte]
	/*
	// TL0 (Timer 0 Low Byte) = 26
	*/
	TL0 = (26 << TL0_TL0__SHIFT);
	// [TL0 - Timer 0 Low Byte]$
...
extern void TIMER_SETUP_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	TMOD = TMOD_T0M__MODE0 | TMOD_CT0__COUNTER | TMOD_GATE0__ENABLED
