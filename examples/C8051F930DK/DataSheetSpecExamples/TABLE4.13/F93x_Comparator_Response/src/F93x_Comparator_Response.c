...
// by table 4.13 of the datasheet.
//
// Refer to F93x_Comparator_Response_Readme.txt for more information regarding
// the functionality of this code example.
//
// How To Test (Table 4.13 - Response Time):
// ---------------------------------------------------------
...
// 5) To cycle between Comparator mode, push SW0.2 (P0.2).DS3 and DS4
...
//      ON   |  ON   |   Mode 3
//
// 6) Attach oscilloscope probes to P0.0 and P0.3.
// 7) To cycle between CP0 Positive Input VDD/GND, push SW0.3 (P0.3). The
//    length from P0.0 toggled to P0.3 toggled is response time on datasheet
//    for the CP0 in Table 4.13
//
...
void PORT_Init (void)
{
    ...
    P0      |=  0x0D;                   // Set P0.0 P0.2, P0.3 latches to '1'
