...
for the Comparator in Table 4.13, in this program SW0_2 to switch
...
How to Use:
--------------------------------------------------------------------------------
Refer to F93x_Comparator_Response.c for detailed directions on using this
example.
