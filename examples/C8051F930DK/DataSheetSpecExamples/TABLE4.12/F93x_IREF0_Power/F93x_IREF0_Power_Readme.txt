...
modes and different IREF0DAT on datasheet for the IREF0 in Table 4.12, in this
...
Specs Demonstrated:
--------------------------------------------------------------------------------
Table 4.12 IREF0 Power Consumption (source mode)
   - Low Power 
      + Min: --
      + Typ: 10  uA
      + Max: --
...
Table 4.12 IREF0 Power Consumption (sink mode)
   - Low Power 
      + Min: --
      + Typ: 1   uA
      + Max: --
...
How to Use:
--------------------------------------------------------------------------------
Refer to F93x_IREF0_Power.c for detailed directions on using this 
example.
