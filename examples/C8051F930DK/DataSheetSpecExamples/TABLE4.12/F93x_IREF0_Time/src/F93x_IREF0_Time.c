...
// current reference, as specified in table 4.12 of the datasheet.
//
// Refer to F93x_IREF0_Time_Readme.txt for more information regarding
// the functionality of this code example.
//
// How To Test (Table 4.12 - Dynamic Performance):
// ---------------------------------------------------------
...
// 4) Download and run the code on a C8051F930-TB target board.
