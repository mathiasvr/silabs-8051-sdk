...
// and Absolute current error in source current mode.
//
// Refer to F93x_IREF0_Error_Readme.txt for more information regarding
// the functionality of this code example.
//
// How To Test (Table 4.12 - Current Error):
// ---------------------------------------------------------
