...
Program Description:
--------------------------------------------------------------------------------
This example demonstrates the Current Reference full scale error
and Absolute current error in source current mode on datasheet for the IREF0
in Table 4.12, in this program SW0_2 to switch current reference output with
...
How to Use:
--------------------------------------------------------------------------------
Refer to F93x_IREF0_Error.c for detailed directions on using this 
example.
