...
extern void TIMER_SETUP_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	CKCON = CKCON_SCA__SYSCLK_DIV_4 | CKCON_T0M__SYSCLK | CKCON_T2MH__EXTERNAL_CLOCK
...
extern void SMBUS_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	// SLVM (SMBus Slave Address Mask) = 126
	*/
	SMB0ADM = SMB0ADM_EHACK__ADR_ACK_AUTOMATIC | (126 << SMB0ADM_SLVM__SHIFT);
	// [SMB0ADM - SMBus 0 Slave Address Mask]$
