...
extern void TIMER01_0_enter_DefaultMode_2_from_DefaultMode(void) {
	...
	/*
	// TH1 (Timer 1 High Byte) = 239
	*/
	TH1 = (239 << TH1_TH1__SHIFT);
	// [TH1 - Timer 1 High Byte]$

	// $[TL1 - Timer 1 Low Byte]
	/*
	// TL1 (Timer 1 Low Byte) = 239
	*/
	TL1 = (239 << TL1_TL1__SHIFT);
	// [TL1 - Timer 1 Low Byte]$
...
extern void TIMER16_3_enter_DefaultMode_2_from_DefaultMode(void) {
	...
	/*
	// TMR3H (Timer 3 High Byte) = 235
	*/
	TMR3H = (235 << TMR3H_TMR3H__SHIFT);
	// [TMR3H - Timer 3 High Byte]$

	// $[TMR3L - Timer 3 Low Byte]
	/*
	// TMR3L (Timer 3 Low Byte) = 168
	*/
	TMR3L = (168 << TMR3L_TMR3L__SHIFT);
	// [TMR3L - Timer 3 Low Byte]$

	// $[TMR3RLH - Timer 3 Reload High Byte]
	/*
	// TMR3RLH (Timer 3 Reload High Byte) = 235
	*/
	TMR3RLH = (235 << TMR3RLH_TMR3RLH__SHIFT);
	// [TMR3RLH - Timer 3 Reload High Byte]$

	// $[TMR3RLL - Timer 3 Reload Low Byte]
	/*
	// TMR3RLL (Timer 3 Reload Low Byte) = 168
	*/
	TMR3RLL = (168 << TMR3RLL_TMR3RLL__SHIFT);
	// [TMR3RLL - Timer 3 Reload Low Byte]$
