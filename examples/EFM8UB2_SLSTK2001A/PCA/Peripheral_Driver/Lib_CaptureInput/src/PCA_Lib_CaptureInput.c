...
//
// Timer2 overflows are used to toggle pin P3.0 at an overflow rate specified
// by the definition T2_RELOAD_CLOCKS. This signal at P3.0 is provided simply
...
//   P1.4   - Display enable
//   P1.0   - PCA CEX0
//   P3.0   - Timer2 test output
//
//-----------------------------------------------------------------------------
// How To Test: EFM8UB2 STK
//-----------------------------------------------------------------------------
// 1) Short P1.0 and P3.0 together
...
// Alternately:
//
// 1) Run a bench signal generator into the P1.0 pin.
// 2) Place the switch in "AEM" mode.
// 3) Connect the EFM8UB2 STK board to a PC using a mini USB cable.
// 4) Compile and download code to the EFM8UB2 STK board.
//    In Simplicity Studio IDE, select Run -> Debug from the menu bar,
