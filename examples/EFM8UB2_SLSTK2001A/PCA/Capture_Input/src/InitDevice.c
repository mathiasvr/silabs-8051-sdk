...
extern void PCA_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	PCA0MD = PCA0MD_CPS__T0_OVERFLOW | PCA0MD_CIDL__NORMAL | PCA0MD_ECF__OVF_INT_DISABLED
...
extern void PBCFG_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	XBR1 = XBR1_WEAKPUD__PULL_UPS_ENABLED | XBR1_XBARE__ENABLED | XBR1_PCA0ME__CEX0
...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TH0 (Timer 0 High Byte) = 0x88
	*/
	TH0 = (0x88 << TH0_TH0__SHIFT);
	// [TH0 - Timer 0 High Byte]$

	// $[TL0 - Timer 0 Low Byte]
	/*
	// TL0 (Timer 0 Low Byte) = 0xFF
	*/
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 0xF4
	*/
	...
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0x48
	*/
	TMR2RLL = (0x48 << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
