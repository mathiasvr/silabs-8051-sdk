...
extern void VREF_0_enter_DefaultMode_from_RESET(void) {
	...
	//     Temperature Sensor.)
	// REFBE (Internal Reference Buffer Enable) = ENABLED (Enable the
	//     internal reference buffer. The internal voltage reference is driven on
	//     the VREF pin.)
	...
	//     voltage reference.)
	*/
	REF0CN = REF0CN_TEMPE__ENABLED | REF0CN_REFBE__ENABLED | REF0CN_REFBGS__GAIN_2
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0x38
	*/
	TMR2RLL = (0x38 << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
