...
extern void PORTS_2_enter_DefaultMode_from_RESET(void) {
	...
	//     analog mode.)
	// B2 (Port 2 Bit 2 Input Mode) = ANALOG (P2.2 pin is configured for
	//     analog mode.)
	// B3 (Port 2 Bit 3 Input Mode) = ANALOG (P2.3 pin is configured for
	//     analog mode.)
	// B4 (Port 2 Bit 4 Input Mode) = ANALOG (P2.4 pin is configured for
	//     analog mode.)
	...
	*/
	...
	//     crossbar.)
	// B4 (Port 2 Bit 4 Skip) = SKIPPED (P2.4 pin is skipped by the
	//     crossbar.)
...
extern void VREF_0_enter_DefaultMode_from_RESET(void) {
	...
	//     voltage reference.)
	*/
	REF0CN = REF0CN_TEMPE__DISABLED | REF0CN_REFBE__ENABLED | REF0CN_REFBGS__GAIN_2
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0x10
	*/
