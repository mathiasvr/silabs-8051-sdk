//-----------------------------------------------------------------------------
// EFM8UB2_ADC_Lib_Interrupt_Window_Compare.c
//-----------------------------------------------------------------------------
...
//
// The system is clocked by the internal 48 MHz oscillator divided by 2
// in order to conserve power. The ADC is clocked by the system 24 MHz
// clock divided by 6 to minimize the ADC's sampling time.
//
...
//
// Resources:
//   SYSCLK - 48 MHz HFOSC0 / 2 (24 MHz)
//   ADC    - 10-bit, VREF = Unregulated 3.3 VDD / 1  (3.3V)
//            SARCLK = SYSCLK / 6 (4 MHz)
//   P1.6   - Green LED
//   P1.7   - Blue LED
//   P2.0   - Red LED
//   P2.5   - Joystick
