...
// Program Description:
//
// This program presents an example of use of the Timer2 of the EFM8UB2's in
// 16-bit reload counter/timer mode. It uses the EFM8UB2DK as HW platform.
//
