...
extern void PBCFG_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// URT1E (UART1 I/O Output Enable) = ENABLED (UART1 TX, RX routed to Port
	//     pins.)
	// SMB1E (SMBus1 I/O Enable) = DISABLED (SMBus1 I/O unavailable at Port
	//     pins.)
	*/
...
extern void UARTE_1_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// BRL (UART1 Baud Rate Reload Low) = 0x30
	*/
