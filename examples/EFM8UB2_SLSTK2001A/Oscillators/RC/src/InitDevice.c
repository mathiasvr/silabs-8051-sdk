...
extern void EXTOSC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// XFCN (External Oscillator Frequency Control) = MODE4 (Select external
	//     oscillator mode 4: 415 kHz < Crystal frequency <= 1.1 MHz, 200 kHz <
	//     RC/C frequency <= 400 kHz, C mode K factor = 65.)
	// XOSCMD (External Oscillator Mode) = RC_DIV_2 (RC Oscillator Mode with
	//     divide by 2 stage.)
	*/
	XOSC0CN &= ~(XOSC0CN_XFCN__FMASK | XOSC0CN_XOSCMD__FMASK);
	XOSC0CN |= XOSC0CN_XFCN__MODE4
		 | XOSC0CN_XOSCMD__RC_DIV_2;
