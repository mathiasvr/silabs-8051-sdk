...
void ApplyMenuSettings()
{
    ...
    switch (AnalogInput)
    {
    case INPUT_JOY:     AMX0P = AMX0P_AMX0P__ADC0P4;      break;
    case INPUT_EXT:     AMX0P = AMX0P_AMX0P__ADC0P19;      break;
    }
    ...
    switch (SampleRate)
    {
    case RATE_31K25:    CKCON0 &= ~CKCON0_T0M__SYSCLK; TH0 = 64;   break;
    case RATE_62K5:     CKCON0 &= ~CKCON0_T0M__SYSCLK; TH0 = 160;  break;
    case RATE_125K:     CKCON0 |=  CKCON0_T0M__SYSCLK; TH0 = 64;   break;
    case RATE_250K:     CKCON0 |=  CKCON0_T0M__SYSCLK; TH0 = 160;  break;

    case RATE_500K:
    case RATE_500KX2:   CKCON0 |=  CKCON0_T0M__SYSCLK; TH0 = 208;  break;
    }
}
