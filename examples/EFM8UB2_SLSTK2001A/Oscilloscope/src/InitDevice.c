...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	ADC0CF = ADC0CF_ADLJST__LEFT_JUSTIFIED | (0x02 << ADC0CF_ADSC__SHIFT);
	// [ADC0CF - ADC0 Configuration]$
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	// PUSB0 (USB (USB0) Interrupt Priority Control) = LOW (USB0 interrupt
	//     set to low priority level.)
	*/
	EIP1 = EIP1_PADC0__HIGH | EIP1_PWADC0__HIGH | EIP1_PCP0__LOW | EIP1_PCP1__LOW
		 | EIP1_PPCA0__LOW | EIP1_PSMB0__LOW | EIP1_PT3__LOW | EIP1_PUSB0__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
