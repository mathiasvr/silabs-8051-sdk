//-----------------------------------------------------------------------------
// EFM8UB2_TemperatureSensor_WithCompensation.c
//-----------------------------------------------------------------------------
...
//
//    T(C) = 0.348Vtemp - 266.20 (V in millivolts)
//
// Converting from V to an ADC reading:
//
//    T(C) = (0.348*VREF*ADC) - 266.20;
//
// Sampling 256 times:
//
//    T(C) = (0.348*VREF)*(ADC_sum/256) - 266.20;
//
// Assuming a VREF = 1650 mV:
//
//    T(C) = 2.243*ADC_sum - 266.20;
//
...
// 2) Compile and download code to the EFM8UB2 board by selecting
...
#define SLOPE      		          2870 // Slope of the temp transfer function
#define OFFSET        		   764000L // Offset for the temp transfer function
