...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	//     = HIGH (SPI0 interrupt set to high priority level.)
	...
	//     to low priority level.)
	// PS0 (UART0 Interrupt Priority Control) = LOW (UART0 interrupt set to
	//     low priority level.)
	*/
	IP = IP_PX0__LOW | IP_PX1__LOW | IP_PSPI0__HIGH | IP_PT0__LOW
		 | IP_PT1__LOW | IP_PT2__LOW | IP_PS0__LOW;
	// [IP - Interrupt Priority]$
