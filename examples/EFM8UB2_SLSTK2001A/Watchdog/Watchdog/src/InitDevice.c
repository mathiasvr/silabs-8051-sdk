...
extern void HFOSC_0_enter_FastBlink_from_RESET(void) {
	...
	/*
	// IFCN (Oscillator Frequency Divider Control) = SYSCLK_DIV_4 (SYSCLK can
	//     be derived from Internal H-F Oscillator divided by 4 (3 MHz).)
	*/
	HFO0CN &= ~HFO0CN_IFCN__FMASK;
	HFO0CN |= HFO0CN_IFCN__SYSCLK_DIV_4;
	// [HFO0CN - High Frequency Oscillator Control]$
...
extern void TIMER16_2_enter_FastBlink_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 0xD8
	*/
	...
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0xF0
	*/
	TMR2RLL = (0xF0 << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
...
//==============================================================================
extern void enter_SlowBlink_WD_from_RESET(void) {
	// $[Config Calls]
	// Save the SFRPAGE
	uint8_t SFRPAGE_save = SFRPAGE;
	PCA_0_enter_SlowBlink_WD_from_RESET();
	PCACH_4_enter_SlowBlink_WD_from_RESET();
	PORTS_1_enter_SlowBlink_WD_from_RESET();
	PBCFG_0_enter_SlowBlink_WD_from_RESET();
	HFOSC_0_enter_SlowBlink_WD_from_RESET();
	CLOCK_0_enter_SlowBlink_WD_from_RESET();
	CIP51_0_enter_SlowBlink_WD_from_RESET();
	TIMER16_2_enter_SlowBlink_WD_from_RESET();
	INTERRUPT_0_enter_SlowBlink_WD_from_RESET();
	// Restore the SFRPAGE
	SFRPAGE = SFRPAGE_save;
	// [Config Calls]$
...
// PCA_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void PCA_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[PCA0MD - PCA Mode]
	// [PCA0MD - PCA Mode]$
...
// PCACH_4_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void PCACH_4_enter_SlowBlink_WD_from_RESET(void) {
	...
	// ECOM (Channel 4 Comparator Function Enable) = ENABLED (Enable
	//     comparator function.)
	...
	*/
	...
	PCA0CPM4 = PCA0CPM4_CAPN__DISABLED | PCA0CPM4_ECCF__DISABLED | PCA0CPM4_MAT__ENABLED
		 | PCA0CPM4_PWM16__8_BIT | PCA0CPM4_CAPP__DISABLED | PCA0CPM4_ECOM__ENABLED
		 | PCA0CPM4_PWM__DISABLED | PCA0CPM4_TOG__DISABLED;
	// [PCA0CPM4 - PCA Channel 4 Capture/Compare Mode]$

	// $[PCA0CPL4 - PCA Channel 4 Capture Module Low Byte]
	/*
	// PCA0CPL4 (PCA Channel 4 Capture Module Low Byte) = 0xFF
	*/
...
// PORTS_1_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void PORTS_1_enter_SlowBlink_WD_from_RESET(void) {
	// $[P1 - Port 1 Pin Latch]
	// [P1 - Port 1 Pin Latch]$
...
// PBCFG_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void PBCFG_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[XBR1 - Port I/O Crossbar 1]
	/*
	// WEAKPUD (Port I/O Weak Pullup Disable) = PULL_UPS_ENABLED (Weak
	//     Pullups enabled (except for Ports whose I/O are configured for analog
...
// HFOSC_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void HFOSC_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[HFO0CN - High Frequency Oscillator Control]
	/*
	// IFCN (Oscillator Frequency Divider Control) = SYSCLK_DIV_4 (SYSCLK can
	//     be derived from Internal H-F Oscillator divided by 4 (3 MHz).)
...
// CLOCK_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void CLOCK_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[CLKSEL - Clock Select]
	// [CLKSEL - Clock Select]$
...
// CIP51_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void CIP51_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[PFE0CN - Prefetch Engine Control]
	/*
	// FLBWE (Flash Block Write Enable) = BLOCK_WRITE_DISABLED (Each byte of
	//     a firmware flash write is written individually.)
	// PFEN (Prefetch Enable) = DISABLED (Disable the prefetch engine (SYSCLK
	//     < 25 MHz).)
	*/
...
// TIMER16_2_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void TIMER16_2_enter_SlowBlink_WD_from_RESET(void) {
	// $[Timer Initialization]
	// Save Timer Configuration
	uint8_t TMR2CN0_TR2_save = TMR2CN0 & TMR2CN0_TR2__BMASK;
	// Stop Timer
	...
	*/
	...
	// $[TMR2RLH - Timer 2 Reload High Byte]
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 0x3C
	*/
	TMR2RLH = (0x3C << TMR2RLH_TMR2RLH__SHIFT);
	// [TMR2RLH - Timer 2 Reload High Byte]$

	// $[TMR2RLL - Timer 2 Reload Low Byte]
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0xB0
	*/
...
// INTERRUPT_0_enter_SlowBlink_WD_from_RESET
//================================================================================
extern void INTERRUPT_0_enter_SlowBlink_WD_from_RESET(void) {
	// $[EIE1 - Extended Interrupt Enable 1]
	// [EIE1 - Extended Interrupt Enable 1]$
