...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8UB2 STK (SPI Slave) + EFM8UB2 STK (SPI Master)
//-----------------------------------------------------------------------------
// 1) Connect the first EFM8UB2 STK SPI pins to the second EFM8UB2 STK running the
...
// 4) Compile and download code to the first EFM8UB2 STK board.
