...
//
// This example demonstrates the frequency output of the Internal Precision
// Oscillator from 1.8V to 3.6V, as specified on table 4.7 of the datasheet.
//
// Refer to F99x_PR_Oscillator_F_Readme.txt for more information regarding this
