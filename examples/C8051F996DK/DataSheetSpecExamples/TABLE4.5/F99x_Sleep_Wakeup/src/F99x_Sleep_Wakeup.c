...
//
// Refer to F99x_Sleep_Wakeup_Readme.txt for more information regarding this
// code example's functionality.
//
// How to Measure (Table 4.5 - Power Management Wakeup Time):
// -----------------------------------------------
// 1) Ensure a shorting block is placed across J17 header.
...
// 7) Push SW0_2, the time between DS3 and SW_02 from high to low is the sleep
