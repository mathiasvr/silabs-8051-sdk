...
// ADC as specified on table 4.9 of the datasheet.
//
// Refer to F99x_ADC_Continuous_Sample_Readme.txt for more information 
...
//  4) Set #define ADC0_MODE_SELECT to 0. This will initialize the ADC to run
//     at the 10bit conversion model.
//  5) Set #define LOW_POWER_MODE to 0. This will set sample at 300ksps Normal 
//     mode.If Set #define LOW_POWER_MODE to 1. This will set sample at 200 
//     ksps Low power model.
...
//     the ADC enabled.
//  9) Use the switch at P0.2 (SW0_2) to disable the ADC.
...
//  3) Remove all shorting blocks and attach an ammeter between
//     the J17 (IMEASURE) headers.
//  4) Set #define ADC0_MODE_SELECT to 1. This will initialize the ADC to run
//     at the 10bit Tracking model.
//  5) Set #define LOW_POWER_MODE to 0. This will set sample at 280ksps Normal 
//     mode.If Set #define LOW_POWER_MODE to 1. This will set sample at 200 
//     ksps Low power model.
//  6) Compile and download code to a 'F99x device on a C8051F996-TB development
//     board by selecting Run -> Debug from the menus, clicking the Debug button
...
//  3) Remove all shorting blocks and attach an ammeter between
//     the J17 (IMEASURE) headers.
//  4) Set #define ADC0_MODE_SELECT to 2. This will initialize the ADC to run
//     at the 12bit Tracking model.
//  5) Set #define LOW_POWER_MODE to 0. This will set sample at 750ksps Normal 
//     mode.If Set #define LOW_POWER_MODE to 1. This will set sample at 55 
//     ksps Low power model.
//  6) Compile and download code to a 'F99x device on a C8051F996-TB development
//     board by selecting Run -> Debug from the menus, clicking the Debug button
//     in the quick menu, or pressing F11.
...
//     the sampling rate listed for ADC conversation throughput Rate 
//     in Table 4.10.
//
//
...
SI_SBIT(SW0_2, SFR_P0, 2);                 // Switch SW0_2
