...
//    1) Ensure that the J10(VBAT & WALL_PWR) headers have
...
//       block attached to it. Remove the J8-P1.3 (DS4) shorting block
...
//
//
// Refer to F99x_Reset_Delay_Readme.txt for more information.
//-----------------------------------------------------------------------------
...
#include <SI_C8051F990_defs.inc>                // SFR declarations
...
MAIN:
  // Output DS4 (P1.3), DS3 (P1.5).
  mov P1MDOUT, #0x28                    ; enable P1.5 and P1.3 push-pull output
  ...
  ; turn on DS4 only if Power-On RSTSRC bit set
  cjne A, #0x02, LOOP                
  anl P1, #0xF7                         ; activate DS4
