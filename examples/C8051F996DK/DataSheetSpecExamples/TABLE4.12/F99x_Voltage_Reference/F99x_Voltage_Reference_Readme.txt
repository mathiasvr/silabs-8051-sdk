...
reference is set to a default Normal mode . SW0_2 to switch to the Low Power 
mode setting. SW0_3 to turn on/off voltage Reference .
...
How to Use:
--------------------------------------------------------------------------------
Refer to F99x_Voltage_Reference.c for detailed directions on using this 
example.
