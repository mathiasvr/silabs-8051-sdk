...
//
// This example demonstrates the frequency output of the internal Real Time
// Clock, the SmaRTClock, as specified on table 4.9 of the datasheet.
//
// Refer to F99x_SmaRTClock_Readme.txt for more information regarding this
// code example's functionality.
//
// How to Measure (Table 4.9 - SmaRTClock Characteristics):
// -------------------------------------------------
