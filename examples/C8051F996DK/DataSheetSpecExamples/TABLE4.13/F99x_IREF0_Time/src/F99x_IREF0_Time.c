...
//
// Refer to F99x_IREF0_Time_Readme.txt for more information regarding
...
// 6) Attach oscilloscope probes to P0.7 and P1.5.
// 7) To cycle between Reference on/off, push SW0.2 (P0.2).
// 8) The toggle time between P0.7 and P1.5 is the output time on datasheet
