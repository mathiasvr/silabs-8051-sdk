...
//
// This example demonstrates the power consumption of the IREF0 internal
// current reference, as specified on table 4.13 of the datasheet.
//
// Refer to F99x_IREF0_Power_Readme.txt for more information regarding
...
// 8) To cycle between Current Reference mode, push SW0.2 (P0.2).DS3 and DS4
...
//
// 9) To cycle between Reference ON / OFF, push SW0.3 (P0.3).Record the
//    current each time. The difference is the power supply current on 
//    datasheet for the IREF0 in Table 4.13
//
