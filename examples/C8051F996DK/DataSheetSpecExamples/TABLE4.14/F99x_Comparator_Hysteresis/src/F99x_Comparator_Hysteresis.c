...
// as specified by table 4.14 of the datasheet.
//
// Refer to F99x_Comparator_Hysteresis_Readme.txt for more information regarding
// the functionality of this code example.
//
// How To Test (Table 4.14 - Hysteresis):
// ---------------------------------------------------------
...
// 7) To cycle between Comparator modes, push SW0.2 (P0.2). DS3 and DS4
//    will indicate the mode as below :
//
//      DS4  |  DS3  |  CP0 Mode 
//    -------------------------------------
//      OFF  |  OFF  |   Mode 0
...
//      ON   |  OFF  |   Mode 2
//      ON   |  ON   |   Mode 3
// 8) Attach oscilloscope probes to P0.0.
// 9) CP0 negative input is digital supply 1.8v. Use a voltage supply to sweep
//    the voltage at P1.0 as CP0 positive input voltage. Adjusting input voltage
//    refer to CP0 hysteresis character in Table 4.14. observe the P0.0 on the
//    scope. 
// 10) To cycle between Hysteresis type, push SW0.3 (P0.3).
//
//
...
void main (void)
{
    ...
    // Comparator0 Positive Input P1.0
    CPT0MX = 0xE4;
...
// P1.0   analog                        CP0 positive input
...
void PORT_Init (void)
{
    ...
    P1      |= 0x61;                    // Set P1.0, P1.5, P1.6 latches to '1'
    P1SKIP  |= 0x61;                    // P1.0,P1.5, P1.6 skipped in Crossbar
