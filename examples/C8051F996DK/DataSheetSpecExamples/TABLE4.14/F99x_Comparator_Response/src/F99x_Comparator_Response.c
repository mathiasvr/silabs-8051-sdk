...
//
// This example demonstrates the response time of the comparator, as specified
// by table 4.14 of the datasheet.
//
// Refer to F99x_Comparator_Response_Readme.txt for more information regarding
// the functionality of this code example.
//
// How To Test (Table 4.14 - Response Time):
// ---------------------------------------------------------
...
//    b) LED1.3 and P1.3 on J8
//    c) SW0.2 and P0.2H on J8
//    d) SW0.3 on J8 and P1.1 on J13
//    e) IMEASURE J17
...
//      ON   |  ON   |   Mode 3
//
// 7) Attach oscilloscope probes to P0.0 and P1.1.
// 8) To cycle between CP0 Positive Input VDD/GND, push SW0.3 (P1.1).The time
//    from P1.1 toggled to P0.0 toggled that is response time on datasheet for 
//    the CP0 in Table 4.14
//
...
void main (void)
{
    ...
    // Comparator0 Negative Input P1.1
...
// P1.1   analog    Comparator0         Negative Input
...
{
    // Switch,  CP0 output 
    P0MDIN  |=  0x05;                   // P0.0 P0.2 digital
    P0MDOUT &= ~0x04;                   // P0.2 is  open-drain
    P0      |=  0x05;                   // Set P0.0 P0.2 latches to '1'
    P0SKIP  |=  0x04;                   // P0.2 skipped in Crossbar

    // LEDs, CP0 input
    P1MDIN  |= 0x28;                    // P1.3, P1.5 are digital
    P1MDIN  &= ~0x02;                   // P1.1 is analog
    P1MDOUT |= 0x28;                    // P1.5, P1.3 are push-pull
    P1MDOUT &= ~0x02;                   // P1.1 is open-drain
    P1      |= 0x2A;                    // Set P1.1 P1.3, P1.5 latches to '1'
    P1SKIP  |= 0x2A;                    // P1.1, P1.3, P1.5 skipped in Crossbar
