...
//
// This example demonstrates the current consumption of the comparator,
// as specified in table 4.14 of the datasheet.
//
// Refer to F99x_Comparator_Readme.txt for more information regarding
...
// 7) To cycle between Comparator mode, push SW0.2 (P0.2).DS3 and DS4
...
//      ON   |  ON   |   Mode 3
//
// 8) To cycle Comparator ON / OFF, push SW0.3 (P0.3).Record the
