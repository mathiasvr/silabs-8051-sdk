...
//
// Refer to F99x_Clock_External_Readme.txt for more information regarding this
// code example's functionality.
//
// How to Measure (Table 4.2 - External Mode Current):
// -----------------------------------------------
// 1) Ensure that shorting block are attached to the J10(VBAT & WALL_PWR)
...
// 7) Disconnect the debugger. The code should now be running.
// 8) To change the measurement modes, return to step 5).
//
// Target:         C8051F99x
...
//
#define CRYSTAL_FREQUENCY    10000000     //  Crystal Frequency in Hz
