...
extern void PCA_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// PCA0CPL2 (PCA Channel 2 Capture Module Low Byte) = 6
	*/
	PCA0CPL2 = (6 << PCA0CPL2_PCA0CPL2__SHIFT);
	// [PCA0CPL2 - PCA Channel 2 Capture Module Low Byte]$
...
extern void RTC_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// ALARM2 (RTC Alarm Programmed Value 2) = 134
	*/
	RTC0ADR = ALARM2;
	RTC0DAT = (134 << ALARM2_ALARM2__SHIFT);
	while((RTC0ADR & RTC0ADR_BUSY__BMASK) == RTC0ADR_BUSY__SET);    //Poll Busy Bit
	// [ALARM2 - RTC Alarm Programmed Value 2]$

	// $[ALARM3 - RTC Alarm Programmed Value 3]
	/*
	// ALARM3 (RTC Alarm Programmed Value 3) = 61
	*/
	RTC0ADR = ALARM3;
	RTC0DAT = (61 << ALARM3_ALARM3__SHIFT);
	while((RTC0ADR & RTC0ADR_BUSY__BMASK) == RTC0ADR_BUSY__SET);    //Poll Busy Bit
	// [ALARM3 - RTC Alarm Programmed Value 3]$
