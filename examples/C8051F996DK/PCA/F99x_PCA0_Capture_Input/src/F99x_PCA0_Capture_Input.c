...
// in Configurator. This signal at P0.1 is provided simply
...
// 7) Halt the program inside the PCA0_ISR function.
// 8) Verify that the variable "capture_period" is equal to 50 (=500us).
//
// Alternately:
// 1) Ensure that jumpers are placed on the following:
//       J11:  PWR/WALL_PWR
...
// 6) Run the code by selecting Run -> Resume from the menus, clicking the
//    Resume button in the quick menu, or pressing F8.
// 7) Halt the program inside the PCA0_ISR function, line 313.
