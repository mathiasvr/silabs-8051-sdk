...
extern void EXTOSC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// XFCN (External Oscillator Frequency Control) = MODE0 (Select external
	//     oscillator mode 0: Crystal frequency <= 20 kHz, RC/C frequency <= 25
	//     kHz, C mode K factor = 0.87.)
	// XOSCMD (External Oscillator Mode) = CMOS (External CMOS Clock Mode.)
	*/
	OSCXCN = OSCXCN_XFCN__MODE0 | OSCXCN_XOSCMD__CMOS;
	// [OSCXCN - External Oscillator Control]$
