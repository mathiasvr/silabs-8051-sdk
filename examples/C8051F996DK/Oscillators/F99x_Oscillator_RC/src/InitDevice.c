...
extern void EXTOSC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// XFCN (External Oscillator Frequency Control) = MODE1 (Select external
	//     oscillator mode 1: 20 kHz < Crystal frequency <= 58 kHz, 25 kHz < RC/C
	//     frequency <= 50 kHz, C mode K factor = 2.6.)
	// XOSCMD (External Oscillator Mode) = RC (RC Oscillator Mode.)
	*/
	OSCXCN = OSCXCN_XFCN__MODE1 | OSCXCN_XOSCMD__RC;
