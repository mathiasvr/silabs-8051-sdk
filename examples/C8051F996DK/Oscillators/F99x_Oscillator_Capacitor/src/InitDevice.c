...
extern void EXTOSC_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// XFCN (External Oscillator Frequency Control) = MODE2 (Select external
	//     oscillator mode 2: 58 kHz < Crystal frequency <= 155 kHz, 50 kHz <
	//     RC/C frequency <= 100 kHz, C mode K factor = 7.7.)
	// XOSCMD (External Oscillator Mode) = C (Capacitor Oscillator Mode.)
	*/
	OSCXCN = OSCXCN_XFCN__MODE2 | OSCXCN_XOSCMD__C;
