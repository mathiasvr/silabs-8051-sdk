...
extern void PCA_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// PCA0CPH2 (PCA Channel 2 Capture Module High Byte) = 6
	*/
	PCA0CPH2 = (6 << PCA0CPH2_PCA0CPH2__SHIFT);
	// [PCA0CPH2 - PCA Channel 2 Capture Module High Byte]$
...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// ADRPT (Repeat Count) = ACC_16 (Perform and Accumulate 16 conversions
	//     (4 conversions in 12-bit mode).)
	...
	// ADSJST (Accumulator Shift and Justify) = RIGHT_SHIFT_2 (Right
	//     justified. Shifted right by 2 bits.)
	*/
	ADC0AC = ADC0AC_ADRPT__ACC_16 | ADC0AC_AD12BE__12_BIT_DISABLED
		 | ADC0AC_ADAE__ACC_DISABLED | ADC0AC_ADSJST__RIGHT_SHIFT_2;
	// [ADC0AC - ADC0 Accumulator Configuration]$
