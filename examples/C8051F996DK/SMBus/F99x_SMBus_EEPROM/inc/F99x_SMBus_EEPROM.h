...
#ifndef F99X_SMBUS_EEPROM_MAIN_H_
#define F99X_SMBUS_EEPROM_MAIN_H_
...
extern volatile bit SMB_SENDWORDADDR;                  // When set, this flag causes the ISR
                                       // to send the 8-bit <WORD_ADDR>
                                       // after sending the slave address.


extern volatile bit SMB_RANDOMREAD;                    // When set, this flag causes the ISR
...
extern volatile bit SMB_ACKPOLL;                       // When set, this flag causes the ISR
                                       // to send a repeated START until the
                                       // slave has acknowledged its address

#endif /* F99X_SMBUS_EEPROM_MAIN_H_ */
