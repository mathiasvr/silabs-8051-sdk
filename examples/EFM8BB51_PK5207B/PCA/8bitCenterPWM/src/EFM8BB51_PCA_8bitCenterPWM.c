...
// and the crossbar is configured to send the CEX0 signal out on P1.5 (LED0) and the
// CEX1 signal out on P1.6 (LED1).
//
// Resources:
...
//    also be visualized on BRD5207B LED0 and LED1.
