//-----------------------------------------------------------------------------
// EFM8BB51_PWM_Single_Ended_Output.c
//-----------------------------------------------------------------------------
...
// 5) Initially, LED0 and LED1 will each be lit at using a 50% initial
//    duty cycle from PWM0 CH0 (P1.5) and CH1 (P1.6).
...
// 7) Connect oscilloscope probes to P1.5 and P1.6 to view the PWM waveforms
//    on a scope.
//
// Target:         EFM8BB51
// Tool chain:     Generic
//
// Release 0.2 (MR)
//    - Updated PWM Channel 0 to use the LED0 on EFM8BB51 PK
