...
extern void PORTS_1_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   ...
   //     float high.)
   // B5 (Port 1 Bit 5 Latch) = LOW (P1.5 is low. Set P1.5 to drive or
   //     float high.)
  ...
  /*
   ...
   //     drain.)
   // B4 (Port 1 Bit 4 Output Mode) = OPEN_DRAIN (P1.7 output is open-
   //     drain.)
   // B5 (Port 1 Bit 5 Output Mode) = PUSH_PULL (P1.4 output is push-pull.)
   //     drain.)
   // B6 (Port 1 Bit 6 Output Mode) = PUSH_PULL (P1.4 output is push-pull.)
   //     drain.)
   */
  ...
  /*
   ...
   //     crossbar.)
   // B4 (Port 1 Bit 4 Skip) = NOT_SKIPPED (P1.5 pin is not skipped by the
   //     crossbar.)
   // B5 (Port 1 Bit 5 Skip) = SKIPPED (P1.5 pin is skipped by the crossbar.)
   // B6 (Port 1 Bit 6 Skip) = SKIPPED (P1.5 pin is skipped by the crossbar.)
   */
