//-----------------------------------------------------------------------------
// EFM8BB51_ADC_TempSensor_WithoutCompensation.c
//-----------------------------------------------------------------------------
...
//
//    T(C) = (1 / 2.95)Vtemp - (883 mV / 2.95)
//
// In this instance, the equivalent linear equation is given by:
//
//    T(C) = 0.339Vtemp - 299.322 (V in millivolts)
//
// Converting from V to an ADC reading:
//
//    T(C) = (0.339*VREF*ADC) - 299.322;
//
// Sampling 256 times:
//
//    T(C) = (0.339*VREF)*(ADC_sum/256) - 299.322;
//
// Assuming a VREF = 1650 mV:
//
//    T(C) = 2.185*ADC_sum - 299.322;
//
...
#define SLOPE                     2185 // Slope of the temp transfer function
#define OFFSET                 299322L // Offset for the temp transfer function
