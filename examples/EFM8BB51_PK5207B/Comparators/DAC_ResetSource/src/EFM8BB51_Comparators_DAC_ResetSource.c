//-----------------------------------------------------------------------------
// EFM8BB51_Comparators_DAC_ResetSource.c
//-----------------------------------------------------------------------------
...
// the comparator is running in mode 2 and a 25us delay is inserted.
//
...
//   DAC    - Comparator 0 negative input (CP0-), Voltage = 0.5 * VDD
//   P1.5   - LED0
//   P2.0   - Display enable
//
//-----------------------------------------------------------------------------
...
// 5) LED0 should be on (comparator reset not detected).
// 6) Press BTN0 (this causes a comparator reset).
// 7) Verify that LED0 is blinking.
//
// Target:         EFM8BB51
// Tool chain:     Generic
//
