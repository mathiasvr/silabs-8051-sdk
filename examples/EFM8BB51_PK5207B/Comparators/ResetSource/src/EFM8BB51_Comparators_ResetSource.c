//-----------------------------------------------------------------------------
// EFM8BB51_Comparators_ResetSource.c
//-----------------------------------------------------------------------------
...
// the comparator is running in mode 2 and a 25 us delay is inserted.
//
...
// 3) Connect the EFM8BB51 Pro Kit board to a PC using a USB cable.
...
// 6) LED0 should be on (comparator reset not detected).
// 7) Press BTN0 (this causes a comparator reset).
// 8) Verify that LED0 is blinking.
//
// Target:         EFM8BB51
// Tool chain:     Generic
//
...
void main (void)
{
   ...
   else
   {
	   ...
	   Timer0_Delay(25);                 // 25 us delay inserted between Comparator
