...
// toggles LED0 after reaching the value defined by LED_0_TOGGLE_RATE.
//
// When the Timer2 high interrupts, a counter (high_counter) increments and
// toggles LED1 after reaching the value defined by LED_1_TOGGLE_RATE.
//
// Resources:
//   SYSCLK - 24.5 MHz HFOSC0 / 8
//   Timer2L - 10 Hz interrupt
//   Timer2H - 33 Hz interrupt
//   P1.5   - LED0
//   P1.6   - LED1
...
// 5) Check that the LED0 and LED1 are blinking.
//
// Target:         EFM8BB51
// Tool chain:     Generic
//
