...
// will cause an interrupt and toggle LED0. If BTN1 is pressed,then the
// edge-triggered /INT1 input on P0.3 will cause an interrupt and toggle LED1.
//
// Resources:
