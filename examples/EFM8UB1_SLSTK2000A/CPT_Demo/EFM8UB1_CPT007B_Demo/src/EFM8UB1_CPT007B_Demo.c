...
// function board. This demo runs on the EFM8UB1 STK, and communicates with
// CPT007B through the GPIO pins on the EXP header. Virtual buttons on
// STK's LCD screen indicate whether the capacitive sensing buttons on
