...
extern void ADC_0_enter_DefaultMode_from_RESET(void)
{
  ...
  /*
   ...
   //     conversion signal.)
   */
  ADC0CF = (0x03 << ADC0CF_ADSC__SHIFT)
           | ADC0CF_AD8BE__NORMAL
           | ADC0CF_ADGN__GAIN_0P5
...
extern void VREF_0_enter_DefaultMode_from_RESET(void)
{
  ...
  /*
   ...
   //     is the GND pin.)
   // IREFLVL (Internal Voltage Reference Level) = 2P4 (The internal
   //     reference operates at 2.4 V nominal.)
   // REFSL (Voltage Reference Select) = INTERNAL_VREF (The ADC0 voltage
   //     reference is the internal voltage reference.)
   */
  REF0CN = REF0CN_TEMPE__TEMP_DISABLED
