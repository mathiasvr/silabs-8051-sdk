...
def main():
    ...
    for i in range(1, len(sys.argv)):
        ...
        # Make code constant
        text = text.replace("static code const char", "static char")
        ...
        print('"C:\Program Files\ImageMagick-6.8.9-Q16\convert.exe" "' + filenameXbm + '" PNG:"' + filenamePng + '"')
        call('"C:\Program Files\ImageMagick-6.8.9-Q16\convert.exe" "' + filenameXbm + '" PNG:"' + filenamePng + '"')
