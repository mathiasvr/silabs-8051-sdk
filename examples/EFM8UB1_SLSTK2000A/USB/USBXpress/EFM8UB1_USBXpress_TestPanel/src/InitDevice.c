...
PORTS_2_enter_DefaultMode_from_RESET(void)
{
  ...
  /*
   ...
   //     float high.)
   // B3 (Port 2 Bit 3 Latch) = LOW (P2.3 is low. Set P2.3 to drive low.)
   */
...
TIMER16_3_enter_DefaultMode_from_RESET(void)
{
  ...
  /*
   // TMR3RLH (Timer 3 Reload High Byte) = 0xF6
   */
  TMR3RLH = (0xF6 << TMR3RLH_TMR3RLH__SHIFT);
  // [TMR3RLH - Timer 3 Reload High Byte]$

  // $[TMR3RLL - Timer 3 Reload Low Byte]
  /*
   // TMR3RLL (Timer 3 Reload Low Byte) = 0x3C
   */
  TMR3RLL = (0x3C << TMR3RLL_TMR3RLL__SHIFT);
  // [TMR3RLL - Timer 3 Reload Low Byte]$
