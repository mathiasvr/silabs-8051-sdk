...
// Program Description:
//
// This program tests all the functions available in EFM8UB1_FlashPrimitives.c
// and EFM8UB1_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8UB1 devices with less than 8 kB of memory will need to
