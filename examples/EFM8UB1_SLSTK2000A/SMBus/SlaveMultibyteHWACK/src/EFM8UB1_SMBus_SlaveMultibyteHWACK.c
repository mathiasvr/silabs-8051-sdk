//-----------------------------------------------------------------------------
// EFM8UB1_SMBus_SlaveMultibyteHWACK.c
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8UB1 STK (SMBus Slave) + EFM8UB1 STK (SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device first EFM8UB1 STK to second EFM8UB1 STK running the
...
// 4) Compile and download code to the first EFM8UB1 STK board.
...
#include "EFM8UB1_SMBus_SlaveMultibyteHWACK.h"
