...
//   On (QFN28) parts(QFN28 part is used on STK):
//     P1.5   - I2C SDA
//     P1.6   - I2C SCL
//   On (QFN20, QSOP24) parts:
//     P1.1   - I2C SDA
//     P1.2   - I2C SCL
//   P1.4   - LED green
//   P2.3   - Display enable
//
//-----------------------------------------------------------------------------
// How To Test: EFM8UB1 STK (I2C Slave) + Board running SMBus Master
//   (for example, EFM8LB1 STK or a C8051Fxxx DK board)
//-----------------------------------------------------------------------------
// 1) Connect the EFM8UB1 STK to the board running the corresponding
//    SMBus_Master code.
