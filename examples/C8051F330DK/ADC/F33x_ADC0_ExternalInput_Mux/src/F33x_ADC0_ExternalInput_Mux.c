...
//		or pressing F11.
// 4) Connect a serial cable from the DB9 connector to a PC
...
//    - Modified the ISRs to use compiler-agnostic declarations
//		- 6 JAN 2014
//
// Release 1.0
...
// Skip the VREF pin
// Port0 ADC Inputs
uint8_t idata PIN_TABLE[ANALOG_INPUTS] = {1,2,3,6,7};
