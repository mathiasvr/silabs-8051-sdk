...
// 5) Use an oscilloscope to watch the IDAC output on the J1 or P2 header
...
typedef union lng {                    // Access a int32_t variable as two
...
#define AMPLITUDE       50 * 655       // 655 is the scaling factor
                                       // see the Timer3 ISR
