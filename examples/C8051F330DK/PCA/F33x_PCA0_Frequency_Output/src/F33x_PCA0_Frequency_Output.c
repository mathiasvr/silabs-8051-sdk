...
// 3) Connect an oscilloscope probe to P0.0.
...
// 6) A square wave should be visible on the oscilloscope with a frequency
//    of <CEX0_FREQUENCY> (Default 90 kHz).
//
// Target:         C8051F330
...
#define CEX0_FREQUENCY 90000L          // Frequency to output on CEX0 (Hz)
