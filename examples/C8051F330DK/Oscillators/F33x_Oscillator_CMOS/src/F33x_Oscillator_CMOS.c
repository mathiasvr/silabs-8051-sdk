...
// 5) Compile and download code to the C8051F330-TB development board by selecting
...
//         Oscillator
//      - the 'F33x will also output the SYSCLK to a port pin (P0.0) for
//         observation
//
//
// Target:         C8051F330
...
#define CMOS_clock 500000             // CMOS oscillator frequency
