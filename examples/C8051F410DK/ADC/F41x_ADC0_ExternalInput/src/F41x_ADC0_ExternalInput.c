...
// 5) Connect a variable voltage source (between 0 and Vref) to P1.6, or if
//    using the on-board potentiometer, populate the following shorting
//    blocks: J25, J15, J3.
...
void ADC0_Init (void)
{
   ...
   ADC0MX = 0x0E;                      // Set P1.6 as positive input
