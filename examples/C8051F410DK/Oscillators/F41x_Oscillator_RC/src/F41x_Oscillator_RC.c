...
//          VIO_EN
// 2) Ensure that a capacitor (C43) and resistor (R2) are installed.
...
// on the target board was 78.5 kHz.
//
//
// Target:         C8051F41x
...
{
   // Oscillator Pins
   P1MDIN &= ~0x02;                    // P0.3 is analog
   P0SKIP |= 0x02;                     // P1.1 skipped in the Crossbar
