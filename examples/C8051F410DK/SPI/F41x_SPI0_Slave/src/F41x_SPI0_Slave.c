...
// Program Description:
//
// This program configures a C8051F41x as a SPI Slave. The 'F41x MCU
...
// 3) Connect the device to another device running SPI - Master code.
...
//
// P2.1  -  Skipped,     Push-Pull,  Digital (LED D2 on Target Board)
//
//-----------------------------------------------------------------------------
void PORT_Init (void)
{
