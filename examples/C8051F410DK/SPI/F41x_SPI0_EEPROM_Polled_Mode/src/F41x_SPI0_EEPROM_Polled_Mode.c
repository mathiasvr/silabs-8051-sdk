...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F41x MCU
...
// connections of the 'F41x MCU are shown here:
//
...
// P2.1 - LED        (digital output, push-pull)
//
//
// How To Test:
//
...
// 3) Connect the device to a Microchip 25LC320 SPI EEPROM.
...
// 4) Connect the USB Debug Adapter to J4. If VUNREG is selected on J9,
//    connect the 9V power adapter to P1.
// 5) Connect serial cable from the development board's J8 to a PC.
...
//    Resume button in the quick menu, or pressing F8.
// 9) HyperTerminal will print the progress of the write/read operation, and in
...
// P1.4  -  Skipped,     Open-Drain, Digital (Switch SW2 on Target Board)
// P1.5  -  Skipped,     Open-Drain, Digital (Switch SW3 on Target Board)
// P1.6  -  Unassigned,  Open-Drain, Digital
// P1.7  -  Unassigned,  Open-Drain, Digital

// P2.0  -  Unassigned,  Open-Drain, Digital
// P2.1  -  Skipped,     Push-Pull,  Digital (LED D3 on Target Board)
// P2.2  -  Unassigned,  Open-Drain, Digital
// P2.3  -  Skipped,     Push-Pull,  Digital (LED D5 on Target Board)
