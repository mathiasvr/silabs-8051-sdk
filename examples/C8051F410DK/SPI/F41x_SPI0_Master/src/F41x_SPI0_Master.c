...
// Program Description:
//
// This program configures a C8051F41x as a 4-wire SPI Single Master.
//
...
// 3) Connect the device to another device running SPI - Slave code.
...
void PORT_Init (void)
{
   ...
   P2MDOUT = 0x02;                     // Make the LED push-pull

   P2SKIP = 0x02;                      // Skip the LED (P2.1)
