...
// Program Description:
//
// This example demonstrates how the C8051F80x SMBus interface can communicate
...
// 3) Connect the device to a 24LC02B serial EEPROM (see the EEPROM datasheet
...
//            turning on P1.0_LED at the end the end of the test.
...
void main (void)
{
   ...
   GREEN_LED = LED_OFF;                // Turn off the LED before the test
                                       // starts
