...
// Program Description:
//
// This program presents an example of use of the Timer2 of the C8051F80x's in
// two 8-bit reload counter/timer mode. It uses the 'F800DK as HW platform.
//
...
// 3) If other LED blink rate is required, change LED_TOGGLE_RATE (in ms).
// 4) If other signal toggle rate is required, change SIGNAL_TOGGLE_RATE (in ms).
// 5) Compile and download code to the C8051F800-TB by selecting
//		Run -> Debug from the menus, clicking the Debug button in the quick menu,
//		or pressing F11.
// 6) Run the code by selecting Run -> Resume from the menus, clicking the
//		Resume button in the quick menu, or pressing F8.
//    Verify that LED is blinking and SIGNAL is toggling
//
//
// Target:         C8051F80x
...
#define LED_TOGGLE_RATE           100L // LED toggle rate in milliseconds
                                       // if LED_TOGGLE_RATE = 1, the LED will
                                       // be on for 1 millisecond and off for
                                       // 1 millisecond

#define SIGNAL_TOGGLE_RATE         30L // SIGNAL pin toggle rate in
                                       // milliseconds
