...
//    J32 header (Side B).
// 4) Change the BIT_MODE global constant to choose the correct mode
...
//    or pressing F8.
// 7) Connect an oscilloscope to monitor P0.0.
...
{ 
   ...
   SFRPAGE = CONFIG_PAGE;
   PCA0PWM &= ~PCA0PWM_ARSEL__BMASK;   // Disable Auto-Reload Registers
...
SI_INTERRUPT(PCA0_ISR, PCA0_IRQn)
{
   ...
   SFRPAGE = CONFIG_PAGE;   
   PCA0PWM |= PCA0PWM_ARSEL__AUTORELOAD;// Enable Auto-Reload Registers
   SFRPAGE = LEGACY_PAGE;
