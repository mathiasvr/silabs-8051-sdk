...
SI_SBIT(SW, SFR_P2, 4);                   // Switch pressed='0'
SI_SBIT(GPIO0, SFR_P0, 6);				   // GPIO0/RTS - P0.6
...
void main (void)
{
   ...
   while (1)
   {
	  ...
	  ADC0CN_ADEN = ~ADC0CN_ADEN;      // Toggle the bit
      ...
      // Toggle the GPIO0/RTS pin every other button press to change modes
      GPIO0 = ~GPIO0;
   }
}
