...
// Program Description:
//
// This program is used to measure the temperature sensor on an 'F36x
...
// 2) Connect the ToolStick362DC to a ToolStick Base Adapter.
...
//    after a temperature measurement is taken (line 140).
