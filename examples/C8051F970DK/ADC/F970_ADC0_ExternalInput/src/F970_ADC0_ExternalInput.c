...
// --------------------
//
// This example code takes and averages 256 analog measurements from input
// P5.0 using ADC0, then prints the results to a terminal window via the UART.
//
