...
extern void enter_DefaultMode_from_RESET(void)
{
  ...
  PORTS_5_enter_DefaultMode_from_RESET();
...
extern void PORTS_5_enter_DefaultMode_from_RESET(void)
{
  // $[P5 - Port 5 Pin Latch]
  // [P5 - Port 5 Pin Latch]$
  ...
  // $[P5MDIN - Port 5 Input Mode]
  /***********************************************************************
   - P5.0 pin is configured for analog mode
   - P5.1 pin is configured for digital mode
   - P5.2 pin is configured for digital mode
   ***********************************************************************/
  P5MDIN = P5MDIN_B0__ANALOG | P5MDIN_B1__DIGITAL | P5MDIN_B2__DIGITAL;
  // [P5MDIN - Port 5 Input Mode]$

  // $[P5DRV - Port 5 Drive Strength]
  // [P5DRV - Port 5 Drive Strength]$
...
extern void AMUX_0_enter_DefaultMode_from_RESET(void)
{
  ...
  /***********************************************************************
   - P5.0 pin is connected by the Analog Multiplexer for CS0 or ADC0
   measurements
   - P5.1 pin is not connected by the Analog Multiplexer for CS0 or ADC0
   measurements
   - P5.2 pin is not connected by the Analog Multiplexer for CS0 or ADC0
   measurements
   ***********************************************************************/
  SFRPAGE = 0x00;
  AMUX0P5 = AMUX0P5_B0__CONNECTED | AMUX0P5_B1__NOT_CONNECTED
      | AMUX0P5_B2__NOT_CONNECTED;
  // [AMUX0P5 - Port 5 Analog Multiplexer Control]$
...
extern void RTC_0_enter_DefaultMode_from_RESET(void)
{
   ...
   ***********************************************************************/
  RTC0ADR = RTC0CN;
  RTC0DAT = RTC0CN_RTC0EN__ENABLED | RTC0CN_RTC0TR__STOP
      | RTC0CN_MCLKEN__DISABLED | RTC0CN_RTC0AEN__DISABLED
      | RTC0CN_ALRM__NOT_SET | RTC0CN_RTC0CAP__NOT_SET
