...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
  ...
  /***********************************************************************
   - Enable ADC0 
   - ADC0 Burst Mode Enabled
   - ADC0 conversion initiated on overflow of Timer 2
   ***********************************************************************/
  ADC0CN = ADC0CN_ADEN__ENABLED | ADC0CN_ADBMEN__BURST_ENABLED
      | ADC0CN_ADCM__TIMER2;
  // [ADC0CN - ADC0 Control]$
   ...
   ***********************************************************************/
  ADC0AC = ADC0AC_ADRPT__ACC_16 | ADC0AC_ADAE__ACC_DISABLED
      | ADC0AC_ADSJST__RIGHT_SHIFT_2;
  // [ADC0AC - ADC0 Accumulator Configuration]$
