...
extern void PORTS_4_enter_DefaultMode_from_RESET(void)
{
  ...
  /***********************************************************************
   - P4.0 pin is configured for analog mode
   - P4.1 pin is configured for analog mode
   - P4.2 pin is configured for analog mode
   - P4.3 pin is configured for analog mode
   - P4.4 pin is configured for analog mode
   - P4.5 pin is configured for analog mode
   - P4.6 pin is configured for analog mode
   - P4.7 pin is configured for analog mode
   ***********************************************************************/
  P4MDIN = P4MDIN_B0__ANALOG | P4MDIN_B1__ANALOG | P4MDIN_B2__ANALOG
      | P4MDIN_B3__ANALOG | P4MDIN_B4__ANALOG | P4MDIN_B5__ANALOG
      | P4MDIN_B6__ANALOG | P4MDIN_B7__ANALOG;
  // [P4MDIN - Port 4 Input Mode]$

  // $[P4DRV - Port 4 Drive Strength]
  // [P4DRV - Port 4 Drive Strength]$
...
extern void PORTS_5_enter_DefaultMode_from_RESET(void)
{
  ...
  /***********************************************************************
   - P5.0 output is push-pull
   - P5.1 output is open-drain
   - P5.2 output is open-drain
   ***********************************************************************/
  P5MDOUT = P5MDOUT_B0__PUSH_PULL | P5MDOUT_B1__OPEN_DRAIN
      | P5MDOUT_B2__OPEN_DRAIN;
  // [P5MDOUT - Port 5 Output Mode]$
