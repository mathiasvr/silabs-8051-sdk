//-----------------------------------------------------------------------------
// F97x_Imeasure_Normal_Precision_Oscillator.c
//-----------------------------------------------------------------------------
...
//
// Note that the autoranging feature on a multimeter should not be used, as
// this can cause the device to reset or disconnect from the IDE when switching
// to the precision oscillator.
//
//
// How To Test:
// ------------
...
void Oscillator_Init (void)
{
   ...
   REG0CN |= REG0CN_OSCBIAS__ENABLED; // Enable precision oscillator bias
   OSCICN |= OSCICN_IOSCEN__ENABLED;   // Enable the precision internal osc.
