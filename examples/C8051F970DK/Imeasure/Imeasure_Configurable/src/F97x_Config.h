...
//-----------------------------------------------------------------------------
// Start of F9xx Configuration Options
//-----------------------------------------------------------------------------
...
// Set the constant below to '1' to disable the VDD supply monitor
...
// Set the constant below to use the low frequency oscillator.
...
//    #define CLOCK_SELECTION (LOW_POWER_OSC + OSCILLATOR_DIV_4)
//
...
// CMOS clock must be applied to XTAL2 if using the EXTERNAL_OSC selection
...
#define SMARTCLOCK_OSC_FREQ    32768
   ...
   #define OSCILLATOR_BASE_FREQUENCY LOW_POWER_OSC_FREQ/8
