...
/***************************************************************************//**
 * @addtogroup battery_pack
 * @brief USB Type-C Battery Pack Demo
 *
 * @{
 *
 *   @section battery_pack_contents Contents
 *
 *   @li @ref battery_pack_revision
 *   @li @ref battery_pack_intro
 *   @li @ref battery_pack_instructions
 *
 *   @n @section battery_pack_revision USB Type-C Battery Pack Demo Revision
 *   Revision: 1.0.0
 *
 *   @n @section battery_pack_intro Introduction
 *
 *   The USB Type-C (USBC) Battery Pack Demo implements a rechargeable battery
 *   pack with a USBC connection. It can provide power to a device or receive
 *   power to charge its batteries.
 *
 *   This code is intended to run on the Battery Pack Demo board (BRD5203A).
 *
 *   @n @section battery_pack_instructions Instructions for Use
 *
 *   The Battery Pack is not a proper Dual-Role Power Port, but instead can
 *   operate in either Source or Sink mode. The user can toggle between Source
 *   and Sink modes by pressing the switch labelled "MODE" on the board.
 *
 *   The LED0 and LED1 indicate the current Power Mode:
 *
 *   - When LED0 is on, the device is a Source.
 *   - When LED1 is on, the device is a Sink.
 *
 *   When acting as a Sink, the battery charging status is displayed by the two
 *   STAT LED's:
 *
 *   |-----------------------------------|
 ...
 *   | Charging Disabled | OFF   | OFF   |
 *   |-----------------------------------|
 *
 *   The Boost Active LED indicates the state of the boost regulator.
 *
 ******************************************************************************/
 ...
 * based Battery Pack Application.
 *
 ...
 *
 * The Battery Pack application implements all call-back functions required by
 * the library although some of these functions are irrelevant to this
 * application.
 *
 * This file defines:
...
#define SRC_CHARGING_VOLTAGE          VOLTAGE_5000mV  /**< Voltage available on VBUS when Battery Pack is a Source */
#define SRC_DEFAULT_CHARGING_CURRENT  1500            /**< Default charging current available */

#define SNK_CHARGING_VOLTAGE              VOLTAGE_5000mV  /**< VBus value expected when Battery Pack is a Sink */
#define SNK_OPERATIONAL_CHARGING_CURRENT  500             /**< Operating current when Battery Pack is a Sink */
#define SNK_MAXIMUM_CHARGING_CURRENT      1900            /**< Maximum current when Battery Pack is a Sink */
#define SNK_CHARGING_VOLTAGE_MARGIN_MV    300             /**< Margin for offered voltage (0.3V) */

#define TEMPERATURE_C_OFF       85      /**< Temperature in C at which to stop sourcing/sinking current */
#define TEMPERATURE_C_ON        60      /**< Temperature in C at which to resume sourcing/sinking current */

#define VBAT_MV_OFF             3000    /**< Voltage in mV at which to stop sourcing current */
...
/***************************************************************************//**
 * @addtogroup appvariable    Key variable for the Battery Pack application
 *
...
/***************************************************************************//**
 * @brief
 *    Source Capabilities of Battery Pack Application
 *
 ...
 * of port partner. Battery Pack application keeps track of Sink Capabilities by
 * updating these PDOs whenever a Sink Capabilities message is received.
 ******************************************************************************/
...
/***************************************************************************//**
 * @addtogroup appfunc    Key functions in Battery Pack Application
 *
 ...
 *
 * Battery Pack application needs to enable VBUS at vSafe5V in order for sink to
 * know the connection.
 *****************************************************************************/
 ...
 *
 * Battery Pack application needs to disable VBUS on detach event.
 *****************************************************************************/
