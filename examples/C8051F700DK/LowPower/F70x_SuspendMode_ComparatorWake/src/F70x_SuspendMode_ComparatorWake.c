...
//    - P1.1 - potentiometer R8 or other external voltage source set
//			   to a mid-rail voltage
//    - P1.2 - SW1
...
// 7) Press and hold the switch to toggle the comparator and blink the LED.
//    Release to stop the LED blinking.
//
// Target:         C8051F70x
...
SI_INTERRUPT_PROTO(COMPARATOR_ISR, INTERRUPT_COMPARATOR);
