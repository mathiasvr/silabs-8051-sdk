...
// 3) Connect a USB cable from a PC to the development board.
// 4) Connect a variable voltage source to P1.2 or place a jumper on J16 to connect
//    with the on-board potentiometer R8.
// 5) Compile and download code to the C8051F70x-TB development board by selecting
...
SI_SBIT(R15_ENABLE, SFR_P1, 2);          // Open-Drain output. Write '0' to 
