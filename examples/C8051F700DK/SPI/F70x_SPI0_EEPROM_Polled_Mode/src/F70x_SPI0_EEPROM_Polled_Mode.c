...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F700 MCU
...
// connections of the 'F700 MCU are shown here:
//
...
// 5) Compile and download code to the 'F70x MCU board by selecting
...
// 3) Connect the USB Debug Adapter to P3.
// 4) Connect the USB cable to P4.
// 5) Compile and download code to the 'F80x MCU board by selecting
//		Run -> Debug from the menus, clicking the Debug button in the quick menu,
//		or pressing F11.
// 6) Connect a USB cable from the USB connector of the MCU card to a PC.
...
//    if the verification passes, the DS3 P1.0 LED will blink slowly. If it
...
#define  F_SCK_MAX         200000//2000000     // Max SCK freq (Hz)
