...
// Program Description:
//
// This program configures a C8051F70x as a 4-wire SPI Single Master.
//
...
// 3) Connect the device to another F70x device running SPI0_Slave code.
...
// Parameters   : None
//
// This program configures a C8051F700 as a SPI Master. The 'F700 MCU
// is configured in 4-wire Master Mode.
//
// This example is intended to be used with the SPI0_Slave example.
//
// Pinout:
...
// How To Test:
//
// 1) Download the code to a F700-TB that is connected as above to
//    another device running the SPI0_Master code.
// 2) Verify that the J13 and J14 jumpers are not populated.
// 3) Verify the GREEN LED pin (P1.0) of jumper J8 is populated.
// 4) Run the code.
...
void SPI_Array_Write (void)
{
   ...
   SPI0CN_NSSMD0 = 1;                  // Disable the Slave
