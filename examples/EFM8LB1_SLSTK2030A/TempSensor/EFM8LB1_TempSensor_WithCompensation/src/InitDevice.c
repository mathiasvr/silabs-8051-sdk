...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   ...
   // ADTK (Conversion Tracking Time) = 0x06
   */
...
extern void TIMER16_3_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   // TMR3RLH (Timer 3 Reload High Byte) = 0xFE
   */
  ...
  /*
   // TMR3RLL (Timer 3 Reload Low Byte) = 0x0C
   */
