//-----------------------------------------------------------------------------
// EFM8LB1_ADC_Lib_Accumulate_and_Average.c
//-----------------------------------------------------------------------------
...
// result by eight (right shift by 3) for each conversion. 64 samples are taken
...
//   ADC    - 14-bit, VREF = Internal 1.65 VREF
...
//-----------------------------------------------------------------------------
#define VREF_V         (1.65)
#define ADC_MAX_RESULT_ACCUMULATED  (0x10000UL - 4) // 14 bit ADC oversampled to 16 bits
#define ADC_MAX_RESULT_SINGLE  (0x4000UL - 1) // 14 bit ADC result
