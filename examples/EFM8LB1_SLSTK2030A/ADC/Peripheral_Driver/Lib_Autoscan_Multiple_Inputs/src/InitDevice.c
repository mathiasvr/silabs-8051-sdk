...
extern void ADC14_0_enter_DefaultMode_from_RESET(void) {
   ...
   */
  ADC0CN2 = ADC0CN2_ADCM__TIMER3 | ADC0CN2_PACEN__PAC_DISABLED;
  // [ADC0CN2 - ADC0 Control 2]$
...
extern void TIMER16_3_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   // TMR3H (Timer 3 High Byte) = 0xF6
   */
  TMR3H = (0xF6 << TMR3H_TMR3H__SHIFT);
  // [TMR3H - Timer 3 High Byte]$
...
extern void ADC_0_enter_DefaultMode_from_RESET(void) {
  ...
  /*
   ...
   // ADTK (Conversion Tracking Time) = 0x3F
   */
  ADC0CF1 = ADC0CF1_ADLPM__LP_ENABLED | (0x3F << ADC0CF1_ADTK__SHIFT);
  // [ADC0CF1 - ADC0 Configuration]$
