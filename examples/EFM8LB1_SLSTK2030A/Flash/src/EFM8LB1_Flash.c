...
// Program Description:
//
// This program tests all the functions available in EFM8LB1_FlashPrimitives.c
// and EFM8LB1_FlashUtils.c.  It uses a test data array to mimic the changes
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8LB1 devices with less than 64 kB of memory will need to
