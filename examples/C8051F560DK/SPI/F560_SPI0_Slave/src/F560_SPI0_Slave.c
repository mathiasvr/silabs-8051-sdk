...
// Program Description:
//
// This program configures a C8051F560 as a SPI Slave. The 'F560 MCU
...
// How To Test:
//
// 1) Download the code to a F560-TB that is connected as above to
//    another device running the SPI0_Master code.
// 1) Verify that J22 (Side A) and J5 (Side B) is not populated.
// 3) Verify the LED pins of jumper J19 (Side A) and J15 (Side B) are populated.
// 4) Run the code.
...
void PORT_Init (void)
{
   ...
   P0MDOUT  = 0x02;                    // Configure MISO to push-pull
