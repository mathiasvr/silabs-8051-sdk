...
// Program Description:
//
// This example demonstrates how the C8051F560 SMBus interface can communicate
...
// 2) Download code to a 'F560 device that is connected to a 24LC02B serial
...
void main (void)
{
   ...
   uint8_t error_flag = 0;                 // Flag for checking EEPROM contents
