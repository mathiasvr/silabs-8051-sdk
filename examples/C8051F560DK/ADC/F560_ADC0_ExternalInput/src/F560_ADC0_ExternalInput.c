...
// which is 5V.  In order to measure this signal using the on-chip 2.2V
...
// Command Line:   None
//
// Release 1.3 / 21 MAR 2017 (ST)
//    -Corrected mV calculation in ADC ISR
//
...
void ADC0_Init (void)
{
   ...
   // Initialize the Gain to account for a 5V input and 2.2 VREF
