...
// Program Description:
//
// This program implements a ToolStick based data logger on the 'F931DC.
...
#define LOG_END_ADDR       0xF7FF      // Last byte of the Flash memory 
                                       // allocated for logging
                                       
#define LOG_ENTRY_SIZE       4         // Number of bytes in each log entry

#define FLASH_PAGE_SIZE     1024       // Number of bytes in each Flash page
