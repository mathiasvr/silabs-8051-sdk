...
SI_SBIT(R8_ENABLE,  SFR_P1, 4);          // Open-Drain output. Write '0' to 
...
#define VREF            3360L          // Voltage Reference
...
//-----------------------------------------------------------------------------
//
// PORT_MATCH_ISR is triggered upon a level transition on the S2 pin (P0.2)
...
void PORT_Init (void)
{
   ...
   // Configure Crossbar
   P0SKIP  = 0xCF;                     // Skip all P0 pins except UART
   P1SKIP  = 0x3F;                     // Skip P1.0 - P1.5, this allows CEX0
                                       // to be routed to P1.6 when enabled.
