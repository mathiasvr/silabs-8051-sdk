//-----------------------------------------------------------------------------
// EFM8BB1_SPI0_EEPROM_Polled_Mode.c
//-----------------------------------------------------------------------------
...
//
// P1.4 - LED1       (digital output, push-pull)
//
//-----------------------------------------------------------------------------
// How To Test:
//-----------------------------------------------------------------------------
// Method1:
// 1) Connect the device to a Microchip 25LC320 SPI EEPROM.
...
//    operations.
// 5) If the verification passes, the LED will blink slowly. If it fails,
//    the LED will be off.
//
// Method2 (optional):
// 1) Connect the device to a Microchip 25LC320 SPI EEPROM.
...
//		Run -> Debug from the menus, clicking the Debug button in the quick menu,
//		or pressing F11.
// 5) Disconnect from the device to begin running the example.
...
//    if the verification passes, the LED will blink slowly. If it
