...
// Program Description:
//
// This program tests all the functions available in EFM8BB1_FlashPrimitives.c
// and EFM8BB1_FlashUtils.c.  It uses a test data array to mimic the changes
...
// 4) Check that the LED is blinking, indicating a passing test.
//
// Option 2:
// 1) Connect the EFM8BB1 LCK board to a PC using a micro USB cable.
// 2) Compile and download code to the EFM8BB1 LCK board.
...
//    In Simplicity Studio IDE, select Run -> Resume from the menu bar,
//    click the Resume button in the quick menu, or press F8.
// 4) View the CODE space by navigating to
...
//        5A 5A 5A 5A 5A 5A
//
// Note: EFM8BB1 devices with less than 8 kB of memory will need to
