...
// sample a voltage using the window compare feature.
//
...
// ISR sets an ADC_WINDOW_COMPARE flag which is checked within the main
...
//
// The main loop prints the sampled voltage over UART. The window compare feature
// will be set to interrupt and print the voltage any time the voltage varies
// by 0.1V.
//
// Resources:
...
//    voltage. After printing the voltage, the window compare function will be
//    reset to trigger on +/- 0.1V change from the current voltage.
// 6) Vary the voltage on P1.7. See the device print the voltage when the voltage
//    is changed by 0.1V or more.
//
// Target:         EFM8BB1
// Tool chain:     Generic
//
