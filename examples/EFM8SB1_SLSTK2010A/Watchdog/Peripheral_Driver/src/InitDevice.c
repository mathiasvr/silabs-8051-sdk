...
extern void CLOCK_0_enter_DefaultMode_from_RESET(void) {
	...
	// CLKSL (Clock Source Select) = LPO_DIV_8 (Clock derived from the
	//     Internal Low Power Oscillator divided by 8.)
	*/
	CLKSEL = CLKSEL_CLKDIV__SYSCLK_DIV_8 | CLKSEL_CLKSL__LPO_DIV_8;
