...
//    SOFTWARE_DELAY
// 5) Connect the EFM8SB1 STK board to a PC using a mini USB cable.
// 6) Compile and download code to the EFM8SB1 STK board.
...
SI_SBIT (SIGNAL, SFR_P1, 0);              // SIGNAL is used to input pulses into
                                       // T0 pin
SI_SBIT (BUTTON1, SFR_P1, 2);             // Button that enables counting
