//-----------------------------------------------------------------------------
// EFM8SB1_ADC_Lib_Interrupt_Low_Power.c
//-----------------------------------------------------------------------------
...
// in turn, is used to turn on the LED.
//
// Resources:
...
// 5) Move the joystick. The LED will light up based on the joystick's position:
//      UP, LEFT, DOWN, and RIGHT - On (Yellow)
//    Note: Place breakpoints within the ConvertDirectionToColor function to
//          verify the position of the joystick.
// 6) Run the code in the Energy Profiler. Note that the average current consumption
//    for this example is approximately 1.5mA, compared to approximately 2.1mA with
...
//-----------------------------------------------------------------------------
//
// Turns on LED depending on the joystick direction given
//
// dir -  JOYSTICK_N = On (Yellow)
//        JOYSTICK_E = On (Yellow)
//        JOYSTICK_S = On (Yellow)
//        JOYSTICK_W = On (Yellow)
