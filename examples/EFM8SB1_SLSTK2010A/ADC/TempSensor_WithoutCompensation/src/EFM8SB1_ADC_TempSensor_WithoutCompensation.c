//-----------------------------------------------------------------------------
// EFM8SB1_ADC_TempSensor_WithoutCompensation.c
//-----------------------------------------------------------------------------
...
#define SLOPE  1896                    // Slope of the temp transfer function
...
void main (void) 
{
   ...
   while (1)                           // Spin forever
   {
      ...
      {            
         ...
         temp_frac = (uint16_t)((temp_scaled - temp_whole*SCALE) / (SCALE/10));
