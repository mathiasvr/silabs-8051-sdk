//-----------------------------------------------------------------------------
// EFM8SB1_Comparators_ResetSource.c
//-----------------------------------------------------------------------------
...
//   P1.2   - Right push button
//   VDD/2  - Comparator0 negative input (CP0-)
//   P1.0   - Comparator0 positive input (CP0+)
//   P1.1   - LED
//   P2.6   - Display enable
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// 1) Connect P1.2 (push button) to P1.0 (comparator positive input) with an
//    external wire.
// 2) Place the switch in "AEM" mode.
// 3) Connect the EFM8SB1 STK board to a PC using a mini USB cable.
// 4) Compile and download code to the EFM8SB1STK board.
//    In Simplicity Studio IDE, select Run -> Debug from the menu bar,
//    click the Debug button in the quick menu, or press F11.
// 5) Run the code.
//    In Simplicity Studio IDE, select Run -> Resume from the menu bar,
//    click the Resume button in the quick menu, or press F8.
// 6) LED should be on (comparator reset not detected).
// 7) Press the right switch (this causes a comparator reset).
...
void main (void)
{
   ...
   else
   {
	  ...
	  RSTSRC |= RSTSRC_C0RSEF__SET;	   // Enable Comparator0 as a reset source
      LED = 1;                         // Turn LED on
