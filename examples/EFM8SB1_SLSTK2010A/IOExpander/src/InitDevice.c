...
TIMER01_0_enter_DefaultMode_from_RESET (void)
{
  ...
  /***********************************************************************
   - Timer 1 High Byte = 0xF9
   ***********************************************************************/
  TH1 = (0xF9 << TH1_TH1__SHIFT);
  // [TH1 - Timer 1 High Byte]$
...
TIMER16_3_enter_DefaultMode_from_RESET (void)
{
  ...
  /***********************************************************************
   - Timer 3 Reload High Byte = 0xEB
   ***********************************************************************/
  TMR3RLH = (0xEB << TMR3RLH_TMR3RLH__SHIFT);
  // [TMR3RLH - Timer 3 Reload High Byte]$

  // $[TMR3RLL - Timer 3 Reload Low Byte]
  /***********************************************************************
   - Timer 3 Reload Low Byte = 0xA8
   ***********************************************************************/
  TMR3RLL = (0xA8 << TMR3RLL_TMR3RLL__SHIFT);
  // [TMR3RLL - Timer 3 Reload Low Byte]$
