...
//   P1.2   - SMBus SDA
//   P1.3   - SMBus SCL
//   P2.7   - Address extension (default address increased by 1 if connected to
//            GND)
//   P1.0   - IRQ (goes to GND if state of input pins are changing)
//
//-----------------------------------------------------------------------------
// How To Test: EFM8SB1 STK (SMBus GPIO Expander) + EFR32 STK (Command
// Interpreter/SMBus Master)
//-----------------------------------------------------------------------------
// 1) Connect the device EFM8SB1 STK to EFR32 STK running the corresponding
//    I2C CLI code.
