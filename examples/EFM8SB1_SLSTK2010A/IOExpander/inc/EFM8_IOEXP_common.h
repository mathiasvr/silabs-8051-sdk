...
// P1.4 - P1.5 delegated as port 1;
// MCU  STK2010A  Function
// port port      description
// P1.2 EXP16     SMB SDA;
// P1.3 EXP15     SMB SCL;
// P2.7 -----     ADDR_EXT;
// P1.0 EXP06     INP_CHANGED_IRQ;
SI_SBIT(IOEXP_INP_CHANGED_IRQ, SFR_P1, 0);
SI_SBIT(IOEXP_ADDR_EXT, SFR_P2, 7);
#define P0DEVMASK                0xFF
#define P1DEVMASK                0x32 // only some pins are enabled as ioexp
