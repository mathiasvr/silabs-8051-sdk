...
// function board. This demo runs on the EFM8SB1 STK, and communicates
...
//This demo supports up to 4 capacitive buttons on CPT007B (CS00 to CS03).
//
//-----------------------------------------------------------------------------
