...
uint8_t Out_y;	// starting y point
...
void updateLCD(void)
{
  uint8_t row, col;
  uint8_t line;
  uint8_t dispLine = 96; // orient the buttons in the center of the LCD screen
