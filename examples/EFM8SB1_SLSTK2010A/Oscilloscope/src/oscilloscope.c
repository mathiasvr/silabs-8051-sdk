...
void DisableJoystickInput()
{
    ...
    REF0CN = (REF0CN & ~REF0CN_REFSL__FMASK) | REF0CN_REFSL__HIGH_SPEED_VREF;
...
void ApplyMenuSettings()
{
    ...
    switch (AnalogInput)
    {
    case INPUT_JOY:     ADC0MX = ADC0MX_ADC0MX__ADC0P12;    break;
    case INPUT_EXT:     ADC0MX = ADC0MX_ADC0MX__ADC0P2;     break;
    }
