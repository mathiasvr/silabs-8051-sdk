...
extern void enter_HighCurrentMode_from_RESET(void) {
	...
	PCACH_0_enter_HighCurrentMode_from_RESET();
...
// PCACH_0_enter_HighCurrentMode_from_RESET
//================================================================================
extern void PCACH_0_enter_HighCurrentMode_from_RESET(void) {
	// $[PCA0 Settings Save]
...
extern void IREF_0_enter_HighCurrentMode_from_RESET(void) {
	...
	*/
	...
	/*
	// PWMEN (PWM Enhanced Mode Enable) = ENHANCED_ENABLED (Enable PWM
	//     Enhanced Mode.)
	// PWMSS (PWM Source Select) = FINE_TUNE_CEX0 (CEX0 selected as the fine-
	//     tuning control signal.)
	*/
	IREF0CF = IREF0CF_PWMEN__ENHANCED_ENABLED | IREF0CF_PWMSS__FINE_TUNE_CEX0;
	// [IREF0CF - Current Reference Configuration]$
