...
// Program Description:
//
// This program flashes LED0 on the EFM8SB1 target board about
...
// 5) LED0 will be: blinking when the device is awake.
//                  OFF when the device is sleeping.
//                  ON constantly if an RTC failure occurs
//
//    TEST OUT (P0.1) will be: LOW when the device is awake.
...
SI_SBIT (TEST_OUT, SFR_P0, 1);      // 1 = Sleeping, 0 = Awake
SI_SBIT (LED0,  SFR_P1, 1);         // Used to show analog acquisition time
