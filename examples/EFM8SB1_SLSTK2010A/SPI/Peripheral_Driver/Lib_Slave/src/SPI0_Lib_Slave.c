...
//
//-----------------------------------------------------------------------------
// How To Test: EFM8SB1 STK (SPI Slave) + EFM8SB1 STK (SPI Master)
//-----------------------------------------------------------------------------
// 1) Connect the first EFM8SB1 STK SPI pins to the second EFM8SB1 STK running the
...
// 6) If the communication passes, the TEST_OUT pins on both the Master
