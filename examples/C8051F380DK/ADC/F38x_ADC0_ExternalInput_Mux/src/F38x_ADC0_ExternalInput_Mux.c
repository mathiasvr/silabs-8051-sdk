...
// 7) Connect a variable voltage source (between 0 and Vref) to the Port2 pins,
...
//    0x05         P2.6
//
uint8_t idata PIN_TABLE[ANALOG_INPUTS] = {0,1,2,3,5,6};
uint8_t idata PIN_MUX_TABLE[ANALOG_INPUTS] = {0,1,2,3,4,5};
