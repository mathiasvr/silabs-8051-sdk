...
// Program Description:
//
// This example demonstrates how the C8051F38x SMBus interface can communicate
...
// 4) Connect the device to a to a 24LC02B serial EEPROM (see the EEPROM
//    datasheet for the pinout information).
...
SI_INTERRUPT_PROTO(SMBus_ISR, SMBUS0_IRQn);
...
//
SI_INTERRUPT(SMBus_ISR, SMBUS0_IRQn)
{
