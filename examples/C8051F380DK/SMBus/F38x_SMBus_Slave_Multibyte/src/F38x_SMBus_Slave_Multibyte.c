...
// Program Description:
//
// Example software to demonstrate the C8051F38x SMBus interface in Slave mode
...
// 4) Connect the device to a to a SMBus Master Multibyte device.
