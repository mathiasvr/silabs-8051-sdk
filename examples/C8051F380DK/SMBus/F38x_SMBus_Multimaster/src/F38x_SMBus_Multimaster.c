...
//      - the 'F38x SMBus master should detect any conflict using SMB0CN_ARBLOST
//      - the 'F38x SMBus master should give up the bus, if necessary, and
//        switch to slave receiver mode
//      - the 'F38x SMBus master should transmit after the other master is done
// - Pinout:
//    P0.0 -> SDA (SMBus)
//    P0.1 -> SCL (SMBus)
//
...
//
//      'F38x Multimaster                     Other C8051Fxxx Multimaster
//         LED (blinks) <------------------------------ Switch
//              SW --------------------------------> LED (blinks)
//
