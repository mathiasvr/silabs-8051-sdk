...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051F38x's
// in 13-bit counter/timer mode. It uses the 'F380DK as HW platform and blinks
