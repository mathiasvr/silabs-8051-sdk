//-----------------------------------------------------------------------------
// F38x_SPI0_EEPROM_Polled_Mode.c
//-----------------------------------------------------------------------------
...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F38x MCU
...
// connections of the 'F38x MCU are shown here:
//
...
// 4) Connect the device to a to a Microchip 25LC320 SPI EEPROM.
...
//
// Method2 (optional):
// 1) Download code to a 'F38x device that is connected as above, and
...
//-----------------------------------------------------------------------------
// 16-bit SFR Definitions for the 'F38x
//-----------------------------------------------------------------------------
...
// P2.0  -  Skipped,     Open-Drain, Digital (Switch S2 on Target Board)
// P2.1  -  Skipped,     Open-Drain, Digital (Switch S3 on Target Board)
