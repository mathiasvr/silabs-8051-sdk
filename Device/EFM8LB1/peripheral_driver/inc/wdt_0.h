...
/**************************************************************************//**
 * @brief
 * Delay a user defined number of WDT clock cycles. This is in response to Errata WDT_E102
 * which stipulates WDT clock cycles delays after WDTCN feed and WDTCN disable.
 *
 * @param systemClkFreq:
 * Frequency of the current divided system clock, in Hz
 * @param wdtClkFreq:
 * Frequency of the current divided WDT clock, in Hz
 * @param wdtClkCycles:
 * Number of WDT clock cycles to delay
 * 
 * The WDT is clocked by the divided output of the LFOSC. This function estimates
 * the number of system clock cycles needed for the delay. This function is not 
 * guaranteed to match the phase or exact timing of the WDT clock edges. Additionally
 * This function will exceed the actual duration of n LFO clock cycles to ensure
 * that the minimum required WDT clock cycles have been delayed. If higher precision
 * or timing is needed, 
 * Erratum WDT_E102.
 *****************************************************************************/
