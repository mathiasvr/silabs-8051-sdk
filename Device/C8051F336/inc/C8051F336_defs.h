...
SI_SFR(P2SKIP, 0xD6);                    // Port 2 Skip *NEW*
SI_SFR(SMB0ADR, 0xD7);                   // SMBus0 Address *NEW*
...
SI_SFR(OSCLCN, 0xE3);                    // Low-Frequency Oscillator Control
SI_SFR(IT01CF, 0xE4);                    // INT0/INT1 Configuration
SI_SFR(EIE1, 0xE6);                      // Extended Interrupt Enable 1
SI_SFR(SMB0ADM, 0xE7);                   // SMBus0 Address Match *NEW*
...
SI_SFR(P1MAT, 0xED);                     // Port 1 Match Register *NEW*
SI_SFR(P1MASK, 0xEE);                    // Port 1 Mask Register *NEW*
...
SI_SFR(P2MDIN, 0xF3);                    // Port 2 Input Mode Configuration *NEW*
SI_SFR(EIP1, 0xF6);                      // Extended Interrupt Priority 1
SI_SFR(PCA0PWM, 0xF7);                   // PCA0 PWM Configuration Register *NEW*
...
SI_SFR(P0MAT, 0xFD);                     // Port 0 Match Register *NEW*
SI_SFR(P0MASK, 0xFE);                    // Port 1 Mask Register *NEW*
