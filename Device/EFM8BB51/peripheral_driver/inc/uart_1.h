 ...
 *
 *****************************************************************************/
#if (EFM8PDL_UART1_AUTO_PAGE == 1) || defined(IS_DOXYGEN)
 ...
 * @{
 *****************************************************************************/
#if (EFM8PDL_UART1_USE_BUFFER == 1) || defined(IS_DOXYGEN)               
...
#if EFM8PDL_UART1_USE_ERR_CALLBACK == 1 || defined(IS_DOXYGEN)
/***************************************************************************//**
 * @brief
 ...
 *
 ******************************************************************************/
#if (EFM8PDL_UART1_USE_STDIO == 1) || defined(IS_DOXYGEN)
