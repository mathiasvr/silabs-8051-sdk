 ...
 *  CLU0_initFlipflop(CLU0_FLIPFLOP_CLOCK_ALTCLK0, false);
 * ~~~~~
 *
...
typedef enum {
  ...
  CLU0_FLIPFLOP_CLOCK_ALTCLK0 = CLU0CF_CLKSEL__ALTCLK0,         //!< The D Flip-flop clock is ALTCLK0 (Timer 5 Overflow).
  CLU0_FLIPFLOP_CLOCK_ALTCLK1 = CLU0CF_CLKSEL__ALTCLK1,         //!< The D Flip-flop clock is ALTCLK1 (Timer 3 Overflow).
