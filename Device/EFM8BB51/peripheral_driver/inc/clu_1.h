 ...
 *  CLU1_initFlipflop(CLU1_FLIPFLOP_CLOCK_ALTCLK0, false);
 * ~~~~~
 *
...
typedef enum {
  ...
  CLU1_FLIPFLOP_CLOCK_ALTCLK0 = CLU1CF_CLKSEL__ALTCLK0,         //!< The D Flip-flop clock is ALTCLK0 (Timer 2 Overflow).
  CLU1_FLIPFLOP_CLOCK_ALTCLK1 = CLU1CF_CLKSEL__ALTCLK1,         //!< The D Flip-flop clock is ALTCLK1 (Timer 4 Overflow).
