 ...
 *
 * ~~~~~.c
 *  // Initialize the flip-flop to be clocked by a timer, output not inverted
 *  CLU2_initFlipflop(CLU2_FLIPFLOP_CLOCK_ALTCLK0, false);
 * ~~~~~
 *
 ...
 * 
 *    // Initialize the flip-flop to be clocked by a timer
 *    CLU2_initFlipflop(CLU2_FLIPFLOP_CLOCK_ALTCLK0, false);
 * 
...
typedef enum {
  ...
  CLU2_FLIPFLOP_CLOCK_ALTCLK0 = CLU2CF_CLKSEL__ALTCLK0,         //!< The D Flip-flop clock is ALTCLK0 (Timer 3 Overflow).
  CLU2_FLIPFLOP_CLOCK_ALTCLK1 = CLU2CF_CLKSEL__ALTCLK1,         //!< The D Flip-flop clock is ALTCLK1 (Timer 5 overflow).
