...
typedef enum {
  ...
  ADC0_CONVERSION_START_CEX2      = ADC0CN2_ADCM__CEX2,   //!< Rising edge of PCA CEX5 starts a conversion.
...
typedef enum {
  ADC0_RESOLUTION_8_BIT  = ADC0CN1_ADBITS__8_BIT,  //!< Select 8-bit resolution.
...
typedef enum {
  ...
  ADC0_POSITIVE_INPUT_VDD_DIV, //!< VDD Supply Pin is ADC Positive Input
