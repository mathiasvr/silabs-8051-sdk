 ...
 * ~~~~~
 *
 * Since the DAC has ten bits of resolution, this translates into:
 * ~~~~~.c
 * Output Value = (Desired Voltage * 0x3FF) / Reference Voltage
 * ~~~~~
 *
 * @note This output value may need to be shifted depending on whether or not left-justify
 *       is enabled. With left-justify enabled, this ten-bit value will need to be
 *       shifted left six times.
 *
...
/** @} (end dac0_runtime DAC0 Runtime API) */
